                    ...
                    {!premiumStatus && authMode === "choices" && (
                      <div className="space-y-3">
                        <button
                          ...
                          disabled={busy}
                          className="w-full border-2 border-foreground py-3 text-sm font-semibold uppercase tracking-wider hover:bg-foreground hover:text-background transition disabled:opacity-40 rounded-sm flex items-center justify-center gap-2"
                        >
