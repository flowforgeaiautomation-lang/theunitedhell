...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-CIZTfS1X.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-DoVn_4QG.mjs").then((n) => n.n);
