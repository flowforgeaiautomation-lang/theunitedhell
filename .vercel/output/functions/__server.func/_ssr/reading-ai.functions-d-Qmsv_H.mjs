...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-d-Qmsv_H.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-WlaDbYEL.mjs").then((n) => n.n);
