...
import { t as translateVisibleText } from "./translation.functions-BEalcP8C.mjs";
import { a as categoryLabel } from "./categories-CY0cJTXM.mjs";
import { t as supabase } from "./client-DP4DKmcf.mjs";
import { a as getLikedComments, c as listComments, l as postReflection, o as getRelated, t as bumpLike } from "./articles.functions-mUlf6cD6.mjs";
import { i as useReadingPrefs, r as articleQ, t as Route } from "./article._slug-D20ESrl5.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-D1Unf4e_.mjs";
import { i as unsaveWord, r as saveWord, t as checkSavedWord } from "./quiz.functions-BsZXr86_.mjs";
import { n as fallbackCoverUrl, t as SmartImage } from "./SmartImage-CSltlVaf.mjs";
import { B as MessageCircle, D as SkipBack, Dt as BookmarkCheck, E as SkipForward, Et as Bookmark, F as Pause, G as Lightbulb, H as Maximize, J as Info, M as RotateCcw, Nt as ArrowBigUp, Ot as BookOpen, P as Play, Q as Hash, S as Square, Z as Heart, _t as ChevronUp, bt as ChevronDown, et as Globe, gt as CircleCheck, ht as CircleX, j as Search, k as Share2, l as Users, lt as Earth, m as TrendingUp, nt as Gauge, o as VolumeX, p as Trophy, r as X, s as Volume2, vt as ChevronRight, w as Sparkles, wt as Building2, yt as ChevronLeft, z as Minimize } from "../_libs/lucide-react.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-B-MeJw7k.js
...
function ReadingExperience({ articleSlug, articleContentRef, articleTitle, articleSections }) {
	...
	(0, import_react.useEffect)(() => {
		if (!signedIn) {
			...
			setSavedNotes(local.filter((n) => n.article_slug === articleSlug));
			return;
		}
		(async () => {
	...
	const aiTranslate = (0, import_react.useCallback)(async () => {
		...
		setShowNoteMenu(false);
		try {
			const translated = (await translateFn({ data: {
				target: lang,
				texts: [text]
			} }))[text] || text;
...
function ArticleAudioPlayer({ articleContentRef, articleTitle }) {
	...
	(0, import_react.useEffect)(() => {
		function loadVoices() {
			const opts = (window.speechSynthesis?.getVoices() || []).filter((voice) => voice.lang.startsWith("en")).map((voice) => ({
				name: voice.name,
				lang: voice.lang,
				uri: voice.voiceURI
			}));
