...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-CykzJTro.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-BINK6kQJ.mjs").then((n) => n.n);
