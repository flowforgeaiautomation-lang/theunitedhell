...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-DPF0L4VA.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-Dl_1PGjX.mjs").then((n) => n.n);
