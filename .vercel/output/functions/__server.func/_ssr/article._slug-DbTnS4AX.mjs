...
import { t as translateVisibleText } from "./translation.functions-3CnJq6IL.mjs";
import { a as categoryLabel } from "./categories-BEROsZZ5.mjs";
import { t as supabase } from "./client-d8MeWTAO.mjs";
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-D-Az4fCO.mjs";
import { c as articleQ, l as useReadingPrefs, s as Route } from "./article._slug-DozxIg83.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-CGuz9hVp.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-DbTnS4AX.js
...
function ReadingExperience({ articleSlug, articleContentRef, readingTimeSeconds, articleTitle, articleSections }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const interval = setInterval(async () => {
			if (progress > 0) await supabase.from("reading_progress").upsert({
