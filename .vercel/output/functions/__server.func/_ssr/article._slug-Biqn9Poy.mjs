...
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-DjcJbloA.mjs";
import { n as articleQ, t as Route } from "./article._slug-DLsxnAGT.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-guDCACNc.mjs";
import { n as fallbackCoverUrl, t as ArticleCard } from "./article-card-Cy55uR6v.mjs";
import { C as Search, F as Info, J as Clock, K as Earth, L as Heart, M as Lightbulb, O as MessageCircle, Q as ChevronDown, R as Hash, S as Share2, X as CircleCheck, Y as CircleX, Z as ChevronRight, b as Sparkles, c as Users, d as Trophy, et as Building2, f as TrendingUp, lt as ArrowBigUp, m as Trash2, nt as Bookmark, o as Volume2, r as X, rt as BookmarkCheck, w as RotateCcw } from "../_libs/lucide-react.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-Biqn9Poy.js
...
function ArticlePage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							story.vocabulary && story.vocabulary.filter((v) => v.meaning).length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid gap-6",
								children: story.vocabulary.filter((v) => v.meaning).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EnhancedVocabCard, {
									entry: v,
									articleId: article.id,
									index: i
								}, `${v.word}-${i}`))
								...
								className: "grid gap-6",
								children: generateLocalVocabFallback(story.summary || story.main_story || article.dek || article.title || "").filter((v) => v.meaning).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EnhancedVocabCard, {
									entry: v,
									articleId: article.id,
									index: i
								}, `${v.word}-${i}`))
		...
		related.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.section, {
			initial: { opacity: 0 },
...
function generateLocalVocabFallback(text) {
	...
	const words = text.replace(/[^a-zA-Z\s]/g, " ").split(/\s+/).map((w) => w.trim()).filter((w) => w.length >= 6 && w.length <= 16 && !STOPWORDS.has(w.toLowerCase()) && !/^[A-Z][a-z]+$/.test(w));
