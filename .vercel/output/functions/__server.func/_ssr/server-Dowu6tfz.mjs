...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DCA56ApO.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DeDJBVgm.mjs");
