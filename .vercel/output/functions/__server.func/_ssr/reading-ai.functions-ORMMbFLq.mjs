...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-ORMMbFLq.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-BIvKV3Qa.mjs").then((n) => n.n);
