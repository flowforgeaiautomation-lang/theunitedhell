...
//#region node_modules/.nitro/vite/services/ssr/assets/articles.functions-2fMXQJoQ.js
...
async function normalizeArticle(article) {
	...
	const rawVocab = currentStory.vocabulary?.map((v) => ({
		...
		synonyms: v.synonyms || void 0,
		antonyms: v.antonyms || void 0,
