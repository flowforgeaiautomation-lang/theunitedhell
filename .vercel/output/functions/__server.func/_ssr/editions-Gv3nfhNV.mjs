...
import { A as Search, Mt as ArrowRight, r as X, st as ExternalLink } from "../_libs/lucide-react.mjs";
import { n as BOOKS, t as AUTHOR } from "./editions-data-CBkYZZRA.mjs";
import { t as Route } from "./editions-BfurqzyD.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/editions-Gv3nfhNV.js
		...
		if (deepLinkSlug) {
			...
			if (found) {
				...
				requestAnimationFrame(() => {
					document.getElementById(`book-row-${found.slug}`)?.scrollIntoView({
						behavior: "smooth",
						block: "center"
					});
				});
