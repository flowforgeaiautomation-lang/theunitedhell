...
import { c as require_react, i as useQuery, o as useQueryClient, r as useSuspenseQuery, s as require_jsx_runtime, t as useMutation } from "../_libs/react+tanstack__react-query.mjs";
...
import { i as getRelated, o as listComments } from "./articles.functions-DfYOMjFZ.mjs";
import { n as articleQ, t as Route } from "./article._slug-CPFxF0CQ.mjs";
import { i as postComment, o as toggleBookmark, s as toggleLike, t as getMyInteractions } from "./interactions.functions-CR9ZHLP9.mjs";
import { n as fallbackCoverUrl, t as ArticleCard } from "./article-card-Cy55uR6v.mjs";
import { $ as Bookmark, A as Lightbulb, C as RotateCcw, F as Heart, I as Hash, J as ChevronRight, K as CircleX, N as Info, S as Search, W as Earth, Y as ChevronDown, Z as Building2, c as Users, d as Trophy, et as BookmarkCheck, f as TrendingUp, o as Volume2, ot as ArrowBigUp, q as CircleCheck, r as X, x as Share2, y as Sparkles } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-oUDrYL9s.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: questions.map((q, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						q.question_type === "reflection" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
							value: answers[q.id] ?? "",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							story.vocabulary && story.vocabulary.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								className: "text-sm text-muted-foreground",
								children: "No vocabulary available for this article."
							}),
...
function Discussion({ articleId }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "container-read py-16 border-t rule",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "kicker mb-6",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: "A guided conversation"
			}),
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: mutation.isPending ? "Posting…" : "Post to discussion"
						})]
					})
				]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					!isLoading && comments.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted-foreground",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										className: "text-xs text-muted-foreground",
										children: [c.prompt_type && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
