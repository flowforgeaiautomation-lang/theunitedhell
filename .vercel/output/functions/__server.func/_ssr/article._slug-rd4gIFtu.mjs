...
import { t as translateVisibleText } from "./translation.functions-LozPZVOb.mjs";
import { a as categoryLabel } from "./categories-CY0cJTXM.mjs";
import { t as supabase } from "./client-d8MeWTAO.mjs";
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-CsV5Imww.mjs";
import { i as useReadingPrefs, r as articleQ, t as Route } from "./article._slug-BeYfqUm5.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-CW8IMVQs.mjs";
import { n as fallbackCoverUrl, t as SmartImage } from "./SmartImage-CwBzF68f.mjs";
import { $ as Globe, A as Search, C as Sparkles, Dt as BookmarkCheck, E as SkipBack, Et as Bookmark, N as Play, Nt as ArrowBigUp, O as Share2, Ot as BookOpen, P as Pause, R as Minimize, T as SkipForward, V as Maximize, W as Lightbulb, X as Heart, Z as Hash, _t as ChevronUp, bt as ChevronDown, ct as Earth, g as Trash2, gt as CircleCheck, j as RotateCcw, l as Users, m as TrendingUp, mt as CircleX, o as VolumeX, p as Trophy, q as Info, r as X, s as Volume2, tt as Gauge, vt as ChevronRight, wt as Building2, x as Square, yt as ChevronLeft, z as MessageCircle } from "../_libs/lucide-react.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-rd4gIFtu.js
...
var VideoPlayer = (0, import_react.forwardRef)(function VideoPlayer({ src, poster, active }, ref) {
	const [playing, setPlaying] = (0, import_react.useState)(false);
	const localRef = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		const el = localRef.current;
		if (!el) return;
		if (active && playing) el.play().catch(() => {});
		else el.pause();
	}, [active, playing]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex h-16 w-16 items-center justify-center rounded-full bg-background/90 backdrop-blur-sm shadow-lg",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, {
					className: "h-7 w-7 text-foreground ml-1",
					fill: "currentColor"
				})
			})
		})]
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: media.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: item.type === "video" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoPlayer, {
						src: item.src,
						poster: item.poster,
						active: i === index
...
function ArticlePage() {
	...
	const articleMedia = [...article.cover_video_url ? [{
		type: "video",
