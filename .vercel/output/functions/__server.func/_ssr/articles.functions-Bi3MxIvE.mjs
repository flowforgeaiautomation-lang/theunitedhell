...
//#region node_modules/.nitro/vite/services/ssr/assets/articles.functions-Bi3MxIvE.js
...
var bumpLike = createServerFn({ method: "POST" }).inputValidator((d) => objectType({ commentId: stringType().uuid() }).parse(d)).handler(createSsrRpc("a99f29f836fc88007b0fd96eba0dc60d4b0cf77f8a87df2b41968f198dbd0ed3"));
...
//#endregion
export { getCountryStats as a, listComments as c, getBriefingToday as i, postReflection as l, deleteCommentAnon as n, getRelated as o, getArticleBySlug as r, listArticles as s, bumpLike as t, searchArticles as u };
