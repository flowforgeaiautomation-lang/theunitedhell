...
//#region node_modules/.nitro/vite/services/ssr/assets/articles.functions-CLexhcc3.js
...
var postReflection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { data: row, error } = await publicClient().from("comments").insert({
...
//#endregion
export { getArticleBySlug_createServerFn_handler, getBriefingToday_createServerFn_handler, getCountryStats_createServerFn_handler, getFeatured_createServerFn_handler, getRelated_createServerFn_handler, listArticles_createServerFn_handler, listComments_createServerFn_handler, postReflection_createServerFn_handler, searchArticles_createServerFn_handler };
