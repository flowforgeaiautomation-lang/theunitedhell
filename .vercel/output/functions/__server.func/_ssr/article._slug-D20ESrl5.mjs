...
import { c as require_react, n as queryOptions, s as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { I as notFound, m as createFileRoute, p as lazyRouteComponent } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as supabase } from "./client-DP4DKmcf.mjs";
import { a as SITE_URL, c as canonicalUrl, l as newsArticleJsonLd, n as SITE_LOGO, o as articleUrl, r as SITE_NAME, s as breadcrumbJsonLd } from "./seo-D4Vz7BAR.mjs";
import { n as getArticleBySlug } from "./articles.functions-mUlf6cD6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-D20ESrl5.js
...
function useReadingPrefs() {
	const prefs = (0, import_react.useSyncExternalStore)(subscribe, getSnapshot, getServerSnapshot);
	...
	return {
		...
		exportPrefs: (0, import_react.useCallback)(() => {
		...
		importPrefs: (0, import_react.useCallback)((json) => {
			try {
...
var $$splitComponentImporter = () => import("./article._slug-B-MeJw7k.mjs");
...
//#endregion
export { useReadingPrefs as i, applyReadingPrefs as n, articleQ as r, Route as t };
