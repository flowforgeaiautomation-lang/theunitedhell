...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-B-PVJdzK.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-DpTtE_xk.mjs").then((n) => n.n);
