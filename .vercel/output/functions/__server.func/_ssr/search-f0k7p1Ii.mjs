...
import { a as categoryLabel, t as CATEGORIES } from "./categories-CY0cJTXM.mjs";
import { f as searchArticles, l as listArticles } from "./articles.functions-CsV5Imww.mjs";
import { A as Search, Ot as BookOpen, r as X, w as SlidersHorizontal } from "../_libs/lucide-react.mjs";
import { t as ArticleCard } from "./article-card-BJsKB4u0.mjs";
import { t as ArticleCardSkeletonGrid } from "./ArticleCardSkeleton-CFW4eCvQ.mjs";
import { a as searchEditions } from "./editions-data-CBkYZZRA.mjs";
import { t as Route } from "./search-CMK5FFFa.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/search-f0k7p1Ii.js
		...
		children: [
			...
			(submitted || category || country) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					query.isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArticleCardSkeletonGrid, { count: 4 }),
					query.data && displayed.length === 0 && editionResults.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "dek",
						children: "No matches. Try different keywords or filters."
					}),
					editionResults.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mb-12",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 mb-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-4 w-4 text-[#E6C17D]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-xs uppercase tracking-widest text-muted-foreground",
								children: "Editions"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3",
							children: editionResults.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/editions/$slug",
								params: { slug: b.slug },
								className: "group flex gap-3 p-4 border rule hover:bg-foreground/5 transition",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "font-serif text-sm font-bold group-hover:text-[#E6C17D] transition",
										children: b.title
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "text-[0.6rem] uppercase tracking-widest text-muted-foreground/60 mt-1",
										children: [
											b.readingTime,
											" · ",
											b.language
