...
import { orChat } from "./openrouter.server-DBp1OwsK.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-CX4dgd2r.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-BVkuHElG.mjs").then((n) => n.n);
