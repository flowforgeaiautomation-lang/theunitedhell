...
import { t as translateVisibleText } from "./translation.functions-DnWua43d.mjs";
import { a as categoryLabel } from "./categories-BEROsZZ5.mjs";
import { t as supabase } from "./client-d8MeWTAO.mjs";
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-DJmbjJWT.mjs";
import { c as articleQ, l as useReadingPrefs, s as Route } from "./article._slug-JJFSyAad.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-GJKleY7Y.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-BX9-r0QC.js
...
function ArticleAudioPlayer({ articleContentRef, articleTitle }) {
	...
	const speakFrom = (0, import_react.useCallback)((startIdx) => {
		...
		const speakNext = () => {
			...
			utter.lang = "en-US";
			const selected = (window.speechSynthesis?.getVoices() || []).find((v) => v.voiceURI === voiceURI);
