...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-CF6qMj9J.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-B4SO4Art.mjs").then((n) => n.n);
