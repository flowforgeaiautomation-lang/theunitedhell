...
import { i as useReadingPrefs, r as articleQ, t as Route } from "./article._slug-qQWhbB04.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-blEeQ3gR.js
...
function AdSenseAd({ slot = "auto", format = "auto", responsive = true, className = "", style }) {
...
function AdSenseInArticle() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdSenseAd, {
		slot: "auto",
		format: "fluid",
		className: "my-8",
...
function ArticlePage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdSenseInArticle, {}),
