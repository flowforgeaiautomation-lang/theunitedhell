...
//#region node_modules/.nitro/vite/services/ssr/assets/interactions.functions-BvDhPgnI.js
...
var deleteComment = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({ commentId: stringType().uuid() }).parse(d)).handler(createSsrRpc("230a0aabcf513e3531644fb294f65ca89321a3009398c29b47cc30e1cdd40ddd"));
//#endregion
export { postComment as a, toggleLike as c, listMyBookmarks as i, updateMyProfile as l, getMyInteractions as n, saveInterests as o, getMyProfile as r, toggleBookmark as s, deleteComment as t };
