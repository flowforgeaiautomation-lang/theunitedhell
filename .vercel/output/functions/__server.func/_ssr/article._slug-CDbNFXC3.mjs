...
import { c as listComments, l as postReflection, n as deleteCommentAnon, o as getRelated, t as bumpLike } from "./articles.functions-Bigxr2cU.mjs";
import { n as articleQ, t as Route } from "./article._slug-BBBcK3Mt.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-DlYS8n9S.mjs";
import { n as fallbackCoverUrl, t as ArticleCard } from "./article-card-Cy55uR6v.mjs";
import { C as RotateCcw, D as MessageCircle, G as Earth, I as Heart, J as CircleCheck, L as Hash, P as Info, Q as Building2, S as Search, X as ChevronDown, Y as ChevronRight, c as Users, d as Trophy, et as Bookmark, f as TrendingUp, j as Lightbulb, o as Volume2, q as CircleX, r as X, st as ArrowBigUp, tt as BookmarkCheck, x as Share2, y as Sparkles } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-CDbNFXC3.js
...
function Discussion({ articleId }) {
	...
	const mutation = useMutation({
		...
		onMutate: (input) => {
			...
			qc.setQueryData(["comments", articleId], (old = []) => [...old, optimistic]);
			setBody("");
			setReplyBody("");
			setReplyingTo(null);
		},
	...
	useMutation({
		...
		onMutate: (commentId) => {
			qc.setQueryData(["comments", articleId], (old = []) => old.filter((c) => c.id !== commentId));
		},
		onSuccess: () => {
			qc.invalidateQueries({ queryKey: ["comments", articleId] });
