...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-cXW_INUf.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-DnWua43d.mjs").then((n) => n.n);
