...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-BmGGMKrW.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-BsSdICHM.mjs").then((n) => n.n);
