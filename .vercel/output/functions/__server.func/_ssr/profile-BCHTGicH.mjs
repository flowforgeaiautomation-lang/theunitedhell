...
import { i as saveInterests, n as getMyProfile, s as updateMyProfile } from "./interactions.functions-D1Unf4e_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/profile-BCHTGicH.js
...
function ProfilePage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `.line-input{display:block;width:100%;background:transparent;border:0;border-bottom:2px solid var(--color-border);padding:.5rem 0;font-family:var(--font-serif);font-size:1.125rem;outline:none}.line-input:focus{border-color:var(--color-foreground)}` })
		]
	});
}
