...
//#region node_modules/.nitro/vite/services/ssr/assets/information-CZwzK4xY.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: "We respect user privacy and are committed to protecting your personal data."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Data Collection:" }), " We may collect anonymous usage data such as pages visited, time spent, browser type, and device information. If you create an account, we store your email address and reading preferences."]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Google AdSense & Cookies:" }), " Third-party vendors, including Google, use cookies to serve ads based on a user's prior visits to this and other websites. Google's use of advertising cookies enables it and its partners to serve ads to you based on your visit to this site and/or other sites on the internet."]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
								className: "font-serif text-lg leading-relaxed space-y-2 mb-4 pl-6 list-disc",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Google may use the DoubleClick DART cookie to serve ads based on prior visits." }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
										"Third-party vendors and ad networks may also use cookies for ad serving. You can opt out at ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
											href: "https://www.aboutads.info/choices/",
											className: "text-foreground underline hover:no-underline",
											target: "_blank",
											rel: "noopener noreferrer",
											children: "aboutads.info/choices"
										}),
										"."
									] })
								]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Analytics:" }), " We use Google Analytics and Microsoft Clarity to understand site usage. These tools collect anonymous, aggregated data."]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Data Retention:" }), " Anonymous usage data is retained for up to 14 months. Account data is retained until account deletion is requested."]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Your Rights:" }), " You may request access to, correction of, or deletion of your personal data by contacting us at theunitedhell@gmail.com."]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-serif text-lg leading-relaxed",
								children: "We do not knowingly sell personal information to third parties."
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
