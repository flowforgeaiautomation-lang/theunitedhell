...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-xseLGaXy.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-3CnJq6IL.mjs").then((n) => n.n);
