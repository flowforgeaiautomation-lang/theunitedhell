...
//#region node_modules/.nitro/vite/services/ssr/assets/articles.functions-CcYEZFEW.js
...
async function generateFallbackVocab(text, existing) {
	const words = text.replace(/[^a-zA-Z\s]/g, " ").split(/\s+/).filter((w) => {
...
async function normalizeArticle(article) {
	...
	let finalVocab = (currentStory.vocabulary?.map((v) => ({
		...
		contextMeaning: dec(v.context_meaning) || dec(v.contextMeaning) || void 0,
...
//#endregion
export { bumpLike_createServerFn_handler, deleteCommentAnon_createServerFn_handler, editComment_createServerFn_handler, getArticleBySlug_createServerFn_handler, getBriefingToday_createServerFn_handler, getCountryStats_createServerFn_handler, getFeatured_createServerFn_handler, getLikedComments_createServerFn_handler, getRelated_createServerFn_handler, listArticles_createServerFn_handler, listComments_createServerFn_handler, postReflection_createServerFn_handler, searchArticles_createServerFn_handler };
