...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-DLrVF8Xg.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-BgHwiVc6.mjs").then((n) => n.n);
