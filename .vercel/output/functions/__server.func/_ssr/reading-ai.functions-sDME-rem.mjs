...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-sDME-rem.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-FhqGhFYh.mjs").then((n) => n.n);
