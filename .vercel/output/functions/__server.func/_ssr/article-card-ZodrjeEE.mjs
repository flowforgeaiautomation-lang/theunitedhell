...
//#region node_modules/.nitro/vite/services/ssr/assets/article-card-ZodrjeEE.js
...
*/
function SmartImage({ src, alt, width, height, loading = "lazy", className = "", placeholder, aspectClass = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			!loaded && !error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 animate-pulse bg-gradient-to-br from-foreground/[0.04] via-foreground/[0.08] to-foreground/[0.04]" }),
...
//#endregion
export { SmartImage as n, fallbackCoverUrl as r, ArticleCard as t };
