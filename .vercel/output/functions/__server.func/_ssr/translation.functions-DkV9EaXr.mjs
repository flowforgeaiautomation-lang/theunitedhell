...
//#region node_modules/.nitro/vite/services/ssr/assets/translation.functions-DkV9EaXr.js
...
async function doTranslate(texts, source, target) {
	return await libreTranslate(texts, source, target) ?? await googleTranslate(texts, target) ?? await deeplTranslate(texts, target) ?? await aiTranslate(texts, target);
}
