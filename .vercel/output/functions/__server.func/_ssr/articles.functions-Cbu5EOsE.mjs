...
//#region node_modules/.nitro/vite/services/ssr/assets/articles.functions-Cbu5EOsE.js
...
createServerFn({ method: "POST" }).inputValidator((d) => objectType({ commentId: stringType().uuid() }).parse(d)).handler(createSsrRpc("2e086ce7af653a07e731d4c87fcbedb957daba8b4363dceb296dc7528f30266b"));
...
//#endregion
export { getLikedComments as a, listComments as c, getCountryStats as i, postReflection as l, getArticleBySlug as n, getRelated as o, getBriefingToday as r, listArticles as s, bumpLike as t, searchArticles as u };
