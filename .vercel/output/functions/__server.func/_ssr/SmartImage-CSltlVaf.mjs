...
//#region node_modules/.nitro/vite/services/ssr/assets/SmartImage-CSltlVaf.js
...
function SmartImage({ src, alt, width, height, loading = "eager", className = "", placeholder, aspectClass = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [!error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			ref: imgRef,
			src,
			alt,
			width,
			...
			style: { opacity: loaded ? 1 : .3 }
		}), error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "absolute inset-0 flex items-center justify-center bg-neutral-200 dark:bg-neutral-800",
