//#region node_modules/.nitro/vite/services/ssr/assets/categories-BEROsZZ5.js
var CATEGORIES = [
	{
		slug: "all",
		label: "All",
	...
	},
	{
		...
		label: "Future Space Exploration",
		description: "",
		icon: "sparkles"
	},
	{
	...
	{
		slug: "underwater-discoveries",
		label: "Underwater Discoveries",
		description: "",
		icon: "search"
	},
	{
	...
	},
	{
		...
		label: "Ancient Secrets",
		description: "",
		icon: "key"
	},
	{
		slug: "strange-phenomena",
		label: "Strange Phenomena",
		description: "",
		icon: "sparkles"
	},
	{
		slug: "historical-enigmas",
		label: "Historical Enigmas",
		description: "",
		icon: "search"
	},
	{
		slug: "curiosity-stories",
		label: "Curiosity Stories",
		description: "",
		icon: "lightbulb"
	},
	{
	...
	{
		slug: "ancient-traditions",
		label: "Ancient Traditions",
		description: "",
		icon: "book"
	},
	{
	...
	{
		slug: "extraordinary-people",
		label: "Extraordinary People",
		description: "",
		icon: "star"
	},
	{
	...
	{
		slug: "rare-discoveries",
		label: "Rare Discoveries",
		description: "",
		icon: "search"
	},
	{
		slug: "unexpected-knowledge",
		label: "Unexpected Knowledge",
		description: "",
		icon: "sparkles"
	},
	{
	...
	{
		slug: "indian-innovation",
		label: "Indian Innovation",
		description: "",
		icon: "lightbulb"
	},
	{
		slug: "indian-startups",
	...
	{
		slug: "indian-science",
		label: "Indian Science",
		description: "",
		icon: "flask-conical"
	},
	{
		slug: "indian-wildlife",
		label: "Indian Wildlife",
		description: "",
		icon: "paw"
	},
	{
		slug: "indian-discoveries",
		label: "Indian Discoveries",
		description: "",
		icon: "sparkles"
	},
	{
	...
	{
		slug: "most-important-today",
		label: "Most Important Today",
		description: "",
		icon: "calendar"
	},
	{
		slug: "most-important-this-week",
		label: "Most Important This Week",
		description: "",
		icon: "calendar-days"
	},
	{
		slug: "most-important-this-month",
		label: "Most Important This Month",
		description: "",
		icon: "calendar-check"
	},
	{
		slug: "most-important-this-year",
		label: "Most Important This Year",
		description: "",
		icon: "calendar"
	},
	{
	...
	{
		slug: "worlds-greatest",
		label: "World's Greatest",
		description: "",
		icon: "crown"
	},
	{
		slug: "food-culinary-culture",
		label: "Food & Culinary Culture",
		description: "",
		icon: "utensils"
	},
	{
	...
	{
		slug: "culinary-history",
		label: "Culinary History",
		description: "",
		icon: "history"
	},
	{
		slug: "engineering-inventions",
		label: "Engineering & Inventions",
		description: "",
		icon: "wrench"
	},
	{
		slug: "greatest-inventions",
		label: "Greatest Inventions",
		description: "",
		icon: "lightbulb"
	},
	{
	...
	{
		slug: "industrial-innovations",
		label: "Industrial Innovations",
		description: "",
		icon: "factory"
	},
	{
	...
	{
		slug: "ancient-stories",
		label: "Ancient Stories",
		description: "",
		icon: "scroll"
	},
	{
		slug: "rare-extraordinary",
		label: "Rare & Extraordinary",
		description: "",
		icon: "gem"
	},
	{
		slug: "worlds-rarest-things",
		label: "World's Rarest Things",
		description: "",
		icon: "diamond"
	},
	{
	...
	{
		slug: "strongest-economies",
		label: "Strongest Economies",
		description: "",
		icon: "trending-up"
	},
	{
		slug: "tallest-buildings",
		label: "Tallest Buildings",
		description: "",
		icon: "building-2"
	},
	{
		slug: "greatest-universities",
		label: "Greatest Universities",
		description: "",
		icon: "graduation-cap"
	},
	{
		slug: "data-visual-intelligence",
		label: "Data & Visual Intelligence",
		description: "",
		icon: "bar-chart-3"
	},
	{
	...
	{
		slug: "story-evolution",
		label: "Story Evolution",
		description: "",
		icon: "history"
	}
];
...
var CATEGORY_BY_SLUG = Object.fromEntries(CATEGORIES.map((c) => [c.slug, c]));
function categoryLabel(slug) {
	return CATEGORY_BY_SLUG[slug]?.label ?? slug;
}
var HOMEPAGE_CATEGORY_ALIASES = {
	success: [
		"success-stories",
		"billionaires",
		"entrepreneurs",
...
var TRENDING_CATEGORY_ALIASES = /* @__PURE__ */ new Set([
	"trending-now",
	"breaking-news",
	"viral-stories",
	"most-discussed",
...
//#endregion
export { categoryLabel as a, HOMEPAGE_CATEGORIES as i, CATEGORY_SECTIONS as n, relatedCategorySlugs as o, COUNTRIES as r, CATEGORIES as t };
