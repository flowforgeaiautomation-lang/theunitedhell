...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-BGtAe7lI.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-LozPZVOb.mjs").then((n) => n.n);
