...
import { i as getArticleBySlug } from "./articles.functions-CZZNFFr0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-Bz6z8jwn.js
...
function useReadingPrefs() {
	const [prefs, setPrefs] = (0, import_react.useState)(DEFAULT_READING_PREFS);
	...
	(0, import_react.useEffect)(() => {
		...
		(async () => {
			...
			if (isSignedIn) {
				...
				if (!cancelled && data?.prefs && !error) setPrefs({
...
var $$splitComponentImporter = () => import("./article._slug-CDEV8Ggu.mjs");
...
//#endregion
export { PARAGRAPH_SPACING_CSS as a, articleQ as c, LINE_HEIGHT_CSS as i, useReadingPrefs as l, FONT_SIZE_PX as n, READING_WIDTH_CSS as o, FONT_WEIGHT_CSS as r, Route as s, FONT_FAMILY_STACK as t };
