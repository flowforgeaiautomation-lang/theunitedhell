...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions--wqV6hSy.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-CCDV5izf.mjs").then((n) => n.n);
