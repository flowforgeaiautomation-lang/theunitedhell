...
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-DpGGDsg6.mjs";
import { n as articleQ, t as Route } from "./article._slug-CEyK3fxi.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-De3pSaMS.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-DcsO9Dq6.js
...
function EnhancedVocabCard({ entry, articleId, index }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			entry.simpleExplanation && entry.simpleExplanation !== entry.meaning && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			entry.contextMeaning && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mt-2 text-sm text-foreground/80 leading-relaxed border-l-2 border-foreground/20 pl-3",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-semibold",
						children: "Used in this article:"
					}),
					" ",
