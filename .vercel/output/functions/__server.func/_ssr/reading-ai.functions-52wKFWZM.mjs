...
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-52wKFWZM.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-rcuB4GQW.mjs").then((n) => n.n);
