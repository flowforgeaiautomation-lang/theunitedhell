...
import { M as redirect, c as HeadContent, d as createRouter, f as Outlet, g as Link, h as createRootRouteWithContext, l as useLocation, m as createFileRoute, p as lazyRouteComponent, s as Scripts, z as useRouter } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as useServerFn } from "./useServerFn-CrZF2pjq.mjs";
import { l as createServerFn } from "./esm-Dova13aH.mjs";
import { t as createClient } from "../_libs/supabase__supabase-js.mjs";
import { t as createSsrRpc } from "./createSsrRpc-B-EFQRcl.mjs";
import { o as objectType } from "../_libs/zod.mjs";
import { n as toast, t as Toaster } from "../_libs/sonner.mjs";
import { t as supabase } from "./client-d8MeWTAO.mjs";
import { a as SITE_URL, c as canonicalUrl, d as websiteJsonLd, i as SITE_TAGLINE, n as SITE_LOGO, r as SITE_NAME, t as SITE_DESCRIPTION, u as organizationJsonLd } from "./seo-Bz6NKkDJ.mjs";
import { l as listArticles } from "./articles.functions-UfelP8gZ.mjs";
import { n as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { a as PARAGRAPH_SPACING_CSS, i as LINE_HEIGHT_CSS, l as useReadingPrefs, n as FONT_SIZE_PX, o as READING_WIDTH_CSS, r as FONT_WEIGHT_CSS, s as Route$21, t as FONT_FAMILY_STACK } from "./article._slug-DSvGmtFi.mjs";
import { $ as Globe, A as Search, B as Menu, Dt as BookOpen, F as Palette, I as Moon, J as Image, K as LayoutGrid, L as Monitor, Nt as Accessibility, O as Share2, Q as GraduationCap, bt as Check, d as Upload, dt as Contrast, f as Type, ft as Coffee, it as FileText, j as RotateCcw, k as Settings, lt as Download, n as Zap, r as X, u as User, v as TextAlignStart, y as Sun, yt as ChevronDown } from "../_libs/lucide-react.mjs";
import { t as briefingQ } from "./briefing-DY8d-tkp.mjs";
import { n as ScrollToTop, t as CategoryModal } from "./ScrollToTop-DRtZjwEu.mjs";
import { t as discoverQuery } from "./discover-DQnJNgvB.mjs";
import { n as BOOKS } from "./editions-data-CBkYZZRA.mjs";
import { t as Route$22 } from "./editions._slug-BDZWxPJ2.mjs";
import { t as statsQ } from "./map-BKl7gi12.mjs";
import { t as Route$23 } from "./search-BFKc2eSV.mjs";
import { t as homeQuery } from "./routes-BIMfXPdY.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-JzT3J04O.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CMYVvcFm.css";
var getCurrentPanchang = createServerFn({ method: "GET" }).inputValidator((d) => objectType({}).parse(d ?? {})).handler(createSsrRpc("87c613e3bc9e08ccf8247c65872fb34b0db7d6e8b58bb76a75d648a6f5cf34d7"));
...
function PanchangDisplay() {
	const [panchang, setPanchang] = (0, import_react.useState)(null);
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { className: "h-3.5 w-3.5" }),
						activeLabel,
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						className: "py-2",
						children: NAV$1.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: n.to,
							...
							children: [n.to === "/editions" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-3.5 w-3.5" }), n.label]
						}) }, n.to))
					})
				})]
				...
				className: "flex items-center gap-2 border border-foreground/80 px-3 py-1.5 text-[0.72rem] uppercase tracking-[0.18em] hover:bg-foreground hover:text-background transition",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutGrid, { className: "h-3.5 w-3.5" }), "Categories"]
			})]
...
function LanguageSwitcher({ compact = false }) {
	...
	const [current, setCurrent] = (0, import_react.useState)("en");
	...
	const selectLanguage = (code) => {
		...
		setOpen(false);
		if (code !== "en") window.dispatchEvent(new CustomEvent("tuh-language-change", { detail: { language: code } }));
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Globe, { className: "h-4 w-4" }), !compact && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-xs uppercase tracking-widest hidden lg:inline",
				children: currentLang.code
			})]
		}), open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "absolute right-0 top-full mt-2 w-72 border rule bg-background shadow-xl rounded-sm z-50 animate-fade-in",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "p-3 border-b rule",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2 border rule px-2 py-1.5 rounded-sm",
					children: [
				...
				children: [filtered.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						l.code === current && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-4 w-4 text-foreground" })
					]
				}, l.code)), filtered.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function SiteHeader() {
	...
	const [location, setLocation] = (0, import_react.useState)("WORLD");
			...
			children: [
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanchangDisplay, {})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "hidden lg:block",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LanguageSwitcher, { compact: true })
								}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
						...
						}), signedIn && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/bookmarks",
				...
				open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							NAV.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: n.to,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								onClick: () => setOpen(false),
								className: "flex items-center gap-3 py-1 hover:opacity-60",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-4 w-4" }), " Editions"]
							}) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [dark ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "h-4 w-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "h-4 w-4" }), " Dark"]
							}) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: signedIn ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/profile",
								onClick: () => setOpen(false),
								className: "flex items-center gap-3 py-1 hover:opacity-60",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Exploring the world through knowledge, discovery, and truth." }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Powered by verified sources, human oversight, and artificial intelligence." }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "All rights reserved." })
			]
		})]
	});
}
...
function SegmentedControl({ options, value, onChange, labels }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			className: `border rule px-3 py-1.5 text-xs capitalize transition rounded-sm ${value === opt ? "bg-foreground text-background border-foreground" : "hover:bg-foreground/[0.05]"}`,
			children: labels?.[opt] ?? opt
		}, opt))
	});
}
function Toggle({ label, checked, onChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			className: `h-5 w-9 rounded-full border transition relative ${checked ? "bg-foreground border-foreground" : "bg-foreground/10"}`,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `absolute top-0.5 h-4 w-4 rounded-full bg-background border transition-all ${checked ? "left-4" : "left-0.5"}` })
		})]
	});
}
function Slider({ label, value, min, max, step, onChange, format }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "border rule px-4 py-3 rounded-sm",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function SectionLabel({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "kicker mb-3 text-muted-foreground",
		children
	});
}
function NarrationVoiceSelect({ value, onChange }) {
...
function ReadingSettings() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		className: "fixed inset-0 z-50 flex items-stretch sm:items-center justify-end sm:justify-center bg-foreground/20 backdrop-blur-sm",
		onClick: () => setOpen(false),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between border-b rule px-5 py-4 flex-none",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						className: "font-serif text-xl flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "h-5 w-5" }), " Reading Settings"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-muted-foreground hidden sm:inline",
							children: signedIn ? "Synced to your account" : "Saved on this device"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => setOpen(false),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex gap-1 overflow-x-auto border-b rule px-3 py-2 flex-none",
					children: TABS.map((t) => {
						const Icon = t.icon;
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => setTab(t.id),
							className: `flex items-center gap-1.5 px-3 py-1.5 text-xs whitespace-nowrap transition rounded-sm ${tab === t.id ? "bg-foreground text-background" : "hover:bg-foreground/[0.05] text-muted-foreground"}`,
							children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						tab === "text" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Font Size" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
								options: [
									"xs",
									"sm",
									"md",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Font Family" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
								options: [
									"default",
									"serif",
									"sans",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Font Weight" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
								options: [
									"light",
									"regular",
									"medium",
						...
						tab === "layout" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Line Spacing" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
								options: [
									"compact",
									"normal",
									"relaxed",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Paragraph Spacing" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
								options: [
									"compact",
									"normal",
									"spacious"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Reading Width" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
								options: [
									"narrow",
									"medium",
									"wide",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Text Alignment" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
								label: "Indent first paragraph",
								checked: p.indentFirstParagraph,
								onChange: (v) => set({ indentFirstParagraph: v })
							})
						] }),
						tab === "theme" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Theme" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						tab === "accessibility" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.reduceAnimations,
									onChange: (v) => set({ reduceAnimations: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Increase touch targets",
									checked: p.increaseTouchTargets,
									onChange: (v) => set({ increaseTouchTargets: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Larger icons",
									checked: p.largerIcons,
									onChange: (v) => set({ largerIcons: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Focus highlight",
									checked: p.focusHighlight,
									onChange: (v) => set({ focusHighlight: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Color-blind friendly mode",
									checked: p.colorBlindFriendly,
									onChange: (v) => set({ colorBlindFriendly: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Better keyboard navigation",
									checked: p.keyboardNavigation,
									onChange: (v) => set({ keyboardNavigation: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Screen reader optimization",
									checked: p.screenReaderOptimization,
									onChange: (v) => set({ screenReaderOptimization: v })
								})
							]
						}),
						tab === "reading" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Reading progress bar",
									checked: p.readingProgressBar,
									onChange: (v) => set({ readingProgressBar: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Auto scroll",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.keepScreenAwake,
									onChange: (v) => set({ keepScreenAwake: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Reading ruler",
									checked: p.readingRuler,
									onChange: (v) => set({ readingRuler: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Highlight current paragraph",
									checked: p.highlightCurrentParagraph,
									onChange: (v) => set({ highlightCurrentParagraph: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Focus mode (distraction-free)",
									checked: p.focusMode,
									onChange: (v) => set({ focusMode: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Full screen reading",
									checked: p.fullScreenReading,
									onChange: (v) => set({ fullScreenReading: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Sticky table of contents",
									checked: p.stickyToc,
									onChange: (v) => set({ stickyToc: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Mini map for long articles",
									checked: p.miniMap,
									onChange: (v) => set({ miniMap: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Reading achievements",
									checked: p.readingAchievements,
									onChange: (v) => set({ readingAchievements: v })
								})
							]
						}),
						tab === "media" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Slider, {
									...
									value: p.narrationSpeed,
									min: .5,
									max: 2,
									step: .25,
									onChange: (v) => set({ narrationSpeed: v }),
									format: (v) => `${v}x`
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Narration Voice" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NarrationVoiceSelect, {
									value: p.narrationVoice,
									onChange: (v) => set({ narrationVoice: v })
								})] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Highlight text while narrating",
									checked: p.highlightWhileNarrating,
									onChange: (v) => set({ highlightWhileNarrating: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Image Quality" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
									options: [
										"low",
										"medium",
										"high"
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.clickToZoomImages,
									onChange: (v) => set({ clickToZoomImages: v })
								})
							]
						}),
						tab === "learning" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Show vocabulary builder",
									checked: p.showVocabulary,
									onChange: (v) => set({ showVocabulary: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Show difficult words only",
									checked: p.difficultWordsOnly,
									onChange: (v) => set({ difficultWordsOnly: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Vocabulary Difficulty" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
									options: [
										"all",
										"intermediate",
										"advanced"
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.showPronunciation,
									onChange: (v) => set({ showPronunciation: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Show etymology",
									checked: p.showEtymology,
									onChange: (v) => set({ showEtymology: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Auto-save learned words",
									checked: p.autoSaveLearnedWords,
									onChange: (v) => set({ autoSaveLearnedWords: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Show key takeaways",
									checked: p.showKeyTakeaways,
									onChange: (v) => set({ showKeyTakeaways: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Enable quizzes",
									checked: p.enableQuizzes,
									onChange: (v) => set({ enableQuizzes: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Quiz Difficulty" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
									options: [
										"all",
										"intermediate",
										"advanced"
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.reflectionPrompts,
									onChange: (v) => set({ reflectionPrompts: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Bigger picture section",
									checked: p.biggerPicture,
									onChange: (v) => set({ biggerPicture: v })
								})
							]
						}),
						tab === "personalization" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Continue where I left off",
									checked: p.continueWhereLeftOff,
									onChange: (v) => set({ continueWhereLeftOff: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Remember scroll position",
									checked: p.rememberScrollPosition,
									onChange: (v) => set({ rememberScrollPosition: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Default Summary Length" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
									options: [
										"brief",
										"standard",
										"detailed"
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.showRelatedArticles,
									onChange: (v) => set({ showRelatedArticles: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Show recommendations",
									checked: p.showRecommendations,
									onChange: (v) => set({ showRecommendations: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Default Comment Sort" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
									options: [
										"newest",
										"oldest",
										"top"
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Default Comment View" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SegmentedControl, {
									options: ["flat", "threaded"],
									value: p.commentView,
									onChange: (v) => set({ commentView: v })
								})] })
							]
						}),
						tab === "performance" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Data saver",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									onChange: (v) => set({ lazyLoadImages: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Preload next article",
									checked: p.preloadNextArticle,
									onChange: (v) => set({ preloadNextArticle: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Offline reading (cache articles)",
									checked: p.offlineReading,
									onChange: (v) => set({ offlineReading: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									onClick: () => {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RotateCcw, { className: "h-4 w-4" }), " Clear reading cache"]
								})
							]
						}),
						tab === "sharing" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
								...
								checked: p.enableTextHighlighting,
								onChange: (v) => set({ enableTextHighlighting: v })
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-xs text-muted-foreground px-1",
								children: "Highlight any text in an article to save it as a note, copy it, or share it. Your notes sync across devices when signed in."
							})]
						}),
						tab === "advanced" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									...
									checked: p.eyeComfortMode,
									onChange: (v) => set({ eyeComfortMode: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Adaptive font size",
									checked: p.adaptiveFontSize,
									onChange: (v) => set({ adaptiveFontSize: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Focus timer",
									checked: p.focusTimer,
									onChange: (v) => set({ focusTimer: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Immersive reading mode",
									checked: p.immersiveMode,
									onChange: (v) => set({ immersiveMode: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
									label: "Zen mode",
									checked: p.zenMode,
									onChange: (v) => set({ zenMode: v })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "pt-4 border-t rule space-y-2",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											onClick: () => {
												reset();
												toast.success("Reading settings restored to defaults");
											},
											className: "flex items-center gap-2 w-full border rule px-4 py-3 text-sm hover:bg-foreground/[0.05] rounded-sm",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RotateCcw, { className: "h-4 w-4" }), " Restore default settings"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											onClick: exportPrefs,
											className: "flex items-center gap-2 w-full border rule px-4 py-3 text-sm hover:bg-foreground/[0.05] rounded-sm",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { className: "h-4 w-4" }), " Export reading preferences"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											onClick: () => fileRef.current?.click(),
											className: "flex items-center gap-2 w-full border rule px-4 py-3 text-sm hover:bg-foreground/[0.05] rounded-sm",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { className: "h-4 w-4" }), " Import reading preferences"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											ref: fileRef,
											type: "file",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "border-t rule px-5 py-3 flex-none flex items-center justify-between text-xs text-muted-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Changes apply instantly" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Ctrl+Alt+R to toggle" })]
				})
			]
		})
	})] });
...
function RootComponent() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(QueryClientProvider, {
		client: queryClient,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EzoicScriptLoader, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReadingSettings, {}),
...
var $$splitComponentImporter$13 = () => import("./world-Uh2PzdVx.mjs");
var Route$19 = createFileRoute("/world")({
...
var $$splitNotFoundComponentImporter$3 = () => import("./trending-Jr4SDe57.mjs");
var $$splitErrorComponentImporter$3 = () => import("./trending-DX3m7_mf.mjs");
var $$splitComponentImporter$12 = () => import("./trending-CXCaa5e9.mjs");
var Route$18 = createFileRoute("/trending")({
	head: () => ({
		meta: [
	...
	loader: ({ context }) => context.queryClient.ensureQueryData(queryOptions({
		...
		queryFn: async () => (await listArticles({ data: {
			sort: "trending",
			limit: 60
		} })).items
	})),
...
var $$splitComponentImporter$11 = () => import("./reset-password-CGVZsPZK.mjs");
...
var $$splitNotFoundComponentImporter$2 = () => import("./map-BFJ6w5bo.mjs");
var $$splitErrorComponentImporter$2 = () => import("./map-CWVNNoAK.mjs");
var $$splitComponentImporter$10 = () => import("./map-Bcn45h-j.mjs");
var Route$15 = createFileRoute("/map")({
	head: () => ({
		meta: [
			{ title: "World — The United Hell" },
			{
...
var $$splitComponentImporter$9 = () => import("./information-CpRcfz05.mjs");
var Route$14 = createFileRoute("/information")({
	head: () => ({
		meta: [
...
var $$splitComponentImporter$8 = () => import("./editions-DIeN6t81.mjs");
var Route$13 = createFileRoute("/editions")({
	head: () => ({
		meta: [
...
var $$splitComponentImporter$7 = () => import("./discover-BGEUoi3G.mjs");
...
var $$splitNotFoundComponentImporter$1 = () => import("./briefing-mtIqPtWL.mjs");
var $$splitErrorComponentImporter$1 = () => import("./briefing-dMj-gfqt.mjs");
var $$splitComponentImporter$6 = () => import("./briefing-Ns03qiuk.mjs");
...
var $$splitNotFoundComponentImporter = () => import("./routes-CbXvFb9p.mjs");
var $$splitErrorComponentImporter = () => import("./routes-AkwwU2Dx.mjs");
var $$splitComponentImporter$3 = () => import("./routes-ZJ0sHsHe.mjs");
...
var Route$4 = createFileRoute("/api/public/hooks/reprocess")({ server: { handlers: { GET: async ({ request }) => {
	try {
		...
		const { reprocessBatch } = await import("./ingestion.server-BFGTUTGo.mjs");
...
async function handleIngest(params) {
	const { runIngestion } = await import("./ingestion.server-BFGTUTGo.mjs");
...
var Route$1 = createFileRoute("/api/public/hooks/backfill-vocab")({ server: { handlers: { GET: async ({ request }) => {
	try {
		...
		const { backfillVocabulary } = await import("./ingestion.server-BFGTUTGo.mjs");
...
var Route = createFileRoute("/api/public/hooks/backfill-quizzes")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			...
			const { backfillQuizzes } = await import("./ingestion.server-BFGTUTGo.mjs");
...
var WorldRoute = Route$19.update({
	id: "/world",
	path: "/world",
	getParentRoute: () => Route$20
});
var TrendingRoute = Route$18.update({
	id: "/trending",
	path: "/trending",
	getParentRoute: () => Route$20
});
...
var MapRoute = Route$15.update({
	id: "/map",
	path: "/map",
	getParentRoute: () => Route$20
});
var InformationRoute = Route$14.update({
	id: "/information",
	path: "/information",
	getParentRoute: () => Route$20
});
var EditionsRoute = Route$13.update({
	id: "/editions",
	path: "/editions",
	getParentRoute: () => Route$20
});
...
var EditionsSlugRoute = Route$22.update({
	id: "/$slug",
	path: "/$slug",
...
var EditionsRouteChildren = { EditionsSlugRoute };
var rootRouteChildren = {
	...
	BriefingRoute,
	DiscoverRoute,
	EditionsRoute: EditionsRoute._addFileChildren(EditionsRouteChildren),
	InformationRoute,
	MapRoute,
	ResetPasswordRoute,
	SearchRoute,
