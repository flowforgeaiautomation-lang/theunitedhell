...
import { i as getRelated, o as listComments } from "./articles.functions-JElpUud-.mjs";
import { n as articleQ, t as Route } from "./article._slug-CypLW2Yn.mjs";
import { a as postComment, c as toggleLike, n as getMyInteractions, s as toggleBookmark, t as deleteComment } from "./interactions.functions-BvDhPgnI.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-CDuq0BDR.js
...
function KnowledgeCheck({ articleId, story, title, onReflection }) {
	...
	questions.find((q) => q.question_type === "reflection");
	function reset() {
		setAnswers({});
		setSubmitted(false);
	}
