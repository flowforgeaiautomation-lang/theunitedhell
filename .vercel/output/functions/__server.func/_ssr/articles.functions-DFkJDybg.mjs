...
//#region node_modules/.nitro/vite/services/ssr/assets/articles.functions-DFkJDybg.js
...
var summaryCols = "id,slug,title,dek,category,subcategory,cover_image_url,cover_video_url,read_time_minutes,country_code,featured_slot,published_at,created_at,view_count,like_count,bookmark_count,comment_count";
var NAMED_ENTITIES = {
	amp: "&",
	lt: "<",
	gt: ">",
...
var listArticles = createServerFn({ method: "GET" }).inputValidator((d) => objectType({
	...
	if (rpcError) {
		...
		else if (data.sort === "trending") query = query.order("published_at", { ascending: false }).order("id", { ascending: false });
	...
	return {
		items: (result.items || []).map((r) => decodeSummary(r)),
