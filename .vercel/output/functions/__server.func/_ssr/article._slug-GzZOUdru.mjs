...
import { a as numberType, i as enumType, n as arrayType, o as objectType, s as stringType } from "../_libs/zod.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as translateVisibleText } from "./translation.functions-rcuB4GQW.mjs";
import { a as categoryLabel } from "./categories-BEROsZZ5.mjs";
import { t as supabase } from "./client-d8MeWTAO.mjs";
import { a as getArticleImages, c as getLikedComments, d as listComments, f as postReflection, l as getRelated, n as deleteCommentAnon, r as editComment, t as bumpLike } from "./articles.functions-CLywbWRH.mjs";
import { c as articleQ, l as useReadingPrefs, s as Route } from "./article._slug-D3NkSOh8.mjs";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-DWvQsOYX.mjs";
import { n as SmartImage, r as fallbackCoverUrl, t as ArticleCard } from "./article-card-ZodrjeEE.mjs";
import { A as RotateCcw, B as Maximize, C as Sparkles, Ct as BookOpen, D as Share2, E as SkipBack, K as Info, L as Minimize, M as Play, N as Pause, Ot as ArrowBigUp, Q as Globe, R as MessageCircle, St as BookmarkCheck, T as SkipForward, U as Lightbulb, X as Hash, Y as Heart, dt as Clock, et as Gauge, ft as CircleX, g as Trash2, gt as ChevronDown, ht as ChevronRight, k as Search, l as Users, m as TrendingUp, mt as ChevronUp, o as VolumeX, ot as Earth, p as Trophy, pt as CircleCheck, r as X, s as Volume2, x as Square, xt as Bookmark, yt as Building2 } from "../_libs/lucide-react.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/article._slug-GzZOUdru.js
...
*/
function ReadingExperience({ articleSlug, articleContentRef, readingTimeSeconds, articleTitle, articleSections }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		prefs.focusTimer && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				" read",
				readingTimeSeconds > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "text-muted-foreground ml-2",
					children: [
						"~",
						Math.max(0, Math.ceil((readingTimeSeconds - readSeconds) / 60)),
						" min left"
					]
				})
			]
...
function ArticleAudioPlayer({ articleContentRef, articleTitle }) {
	...
	const [currentSentenceIdx, setCurrentSentenceIdx] = (0, import_react.useState)(-1);
	const [sentences, setSentences] = (0, import_react.useState)([]);
	const [progress, setProgress] = (0, import_react.useState)(0);
	const [error, setError] = (0, import_react.useState)("");
	const audioRef = (0, import_react.useRef)(null);
	const sentenceElsRef = (0, import_react.useRef)([]);
	(0, import_react.useEffect)(() => {
		...
		if (savedVolume !== void 0) setVolume(savedVolume);
	}, []);
	(0, import_react.useEffect)(() => {
		...
		script.onload = () => {
			try {
				...
				if (Array.isArray(v)) setVoices(v.map((x) => x.name || String(x)));
			} catch {}
		};
	}, []);
	...
	const generateAndPlay = (0, import_react.useCallback)(async (startIdx = 0) => {
		setError("");
		if (!window.puter) {
	...
	const changeVoice = (0, import_react.useCallback)((v) => {
		setVoice(v);
		localStorage.setItem("tuh-tts-voice", v);
	}, []);
	const seek = (0, import_react.useCallback)((e) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "h-1 bg-foreground/10 cursor-pointer",
			onClick: seek,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: fmtTime(currentTime) }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "/" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: fmtTime(duration) })
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: "p-2 hover:bg-foreground/[0.08] rounded-sm md:hidden",
							"aria-label": "More",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-4 w-4" })
						})
					]
				...
				isPlaying && currentSentenceIdx >= 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-2 text-xs text-muted-foreground italic truncate hidden md:block",
					children: sentences[currentSentenceIdx] || ""
				})
			]
		})]
	});
...
function ArticlePage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.header, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [addedDate && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: addedDate }), article.read_time_minutes > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.figure, {
			initial: {
				opacity: 0,
				scale: .98
			},
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						inlineImagesQuery.data && inlineImagesQuery.data[0] && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InlineImage, {
							src: inlineImagesQuery.data[0],
							alt: article.title
						}),
						...
						inlineImagesQuery.data && inlineImagesQuery.data[1] && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InlineImage, {
							src: inlineImagesQuery.data[1],
							alt: `${article.title} — related scene`
						}),
						...
						inlineImagesQuery.data && inlineImagesQuery.data[2] && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InlineImage, {
							src: inlineImagesQuery.data[2],
							alt: `${article.title} — context`
						}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [prefs.showVocabulary && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		prefs.showRelatedArticles && related.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.section, {
			initial: { opacity: 0 },
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: related.slice(0, 4).map((a, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
					initial: {
						opacity: 0,
						y: 20
					},
...
function generateLocalVocabFallback(text) {
	if (!text || text.trim().length < 10) return [
		...
		},
		{
			...
			simpleExplanation: "Big enough to matter.",
		...
		},
		{
			word: "context",
			partOfSpeech: "noun",
			meaning: "The circumstances that help explain something.",
			simpleExplanation: "The background around an event.",
		...
		},
		{
			word: "implication",
			partOfSpeech: "noun",
			meaning: "A possible consequence or effect.",
			simpleExplanation: "What something might lead to.",
			example: "The policy has broad implications.",
			synonyms: [
				"consequence",
				"result",
				"outcome"
	...
	const words = text.replace(/[^a-zA-Z\s]/g, " ").split(/\s+/).map((w) => w.trim()).filter((w) => w.length >= 6 && w.length <= 16 && !STOPWORDS.has(w.toLowerCase()));
	const freq = /* @__PURE__ */ new Map();
	for (const w of words) {
		const lw = w.toLowerCase();
		freq.set(lw, (freq.get(lw) || 0) + 1);
	}
	const picks = [...freq.entries()].sort((a, b) => b[1] - a[1]).slice(0, 8).slice(0, 6).map(([w]) => w);
	const defaults = [
		{
			word: "analysis",
			partOfSpeech: "noun",
...
function KnowledgeCheckReflection({ articleId, story, title }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KnowledgeCheck, {
		...
		onReflection: (reflectionText) => {
			...
			qc.setQueryData(["comments", articleId], (old = []) => [optimisticComment, ...old]);
			setPosted(true);
...
function Discussion({ articleId }) {
	...
	const editMutation = useMutation({
		mutationFn: ({ commentId, body }) => editFn({ data: {
			commentId,
			body
		} }),
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									c.prompt_type && !isReply && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "kicker text-[0.6rem]",
										children: PROMPTS.find((p) => p.id === c.prompt_type)?.label ?? c.prompt_type
									}),
									formatTimeAgo(c.created_at),
									c.is_edited && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "italic",
										children: "(edited)"
									})
								]
						...
						isEditing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => editBody.trim() && editMutation.mutate({
										commentId: c.id,
										body: editBody.trim()
									}),
									...
									children: editMutation.isPending ? "Saving…" : "Save"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => {
										setEditingId(null);
										setEditBody("");
