...
import { orChat } from "./openrouter.server-49lyNjab.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/reading-ai.functions-C1wLlY0Z.js
/**
...
var aiTranslateSelection = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { translateVisibleText } = await import("./translation.functions-Cups3_K8.mjs").then((n) => n.n);
