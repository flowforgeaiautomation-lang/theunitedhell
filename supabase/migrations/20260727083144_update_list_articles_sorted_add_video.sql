/*
# Update list_articles_sorted RPC to include cover_video_url

1. Changes
- Rebuilds the `list_articles_sorted` function to include `cover_video_url` in all SELECT lists.
- This allows the frontend to know which articles have video content available.
2. Security
- No RLS changes — the function is SECURITY DEFINER and already accessible.
*/

CREATE OR REPLACE FUNCTION public.list_articles_sorted(
