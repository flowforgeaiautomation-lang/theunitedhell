/*
# Fix backfill_article_vocabulary function v3

Simplifies the word extraction query to avoid the column reference issue.
Uses a simpler subquery structure.
*/
...
BEGIN
  ...
  LOOP
    ...
    -- Use unnest to flatten the text[] arrays returned by regexp_matches
