...
const CURATED_VOCAB: VocabEntry[] = [
  ...
  { word: "negotiation", partOfSpeech: "noun", meaning: "Discussion aimed at reaching an agreement.", simpleExplanation: "Talking to make a deal.", example: "The negotiation lasted three days.", synonyms: ["discussion", "bargaining", "dialogue"], antonyms: [], pronunciation: "nɪˌɡoʊʃiˈeɪʃən" },
  { word: "strategy", partOfSpeech: "noun", meaning: "A plan designed to achieve a long-term goal.", simpleExplanation: "A smart plan to reach a goal.", example: "Their strategy focused on slow, steady growth.", synonyms: ["plan", "approach", "tactic"], antonyms: [], pronunciation: "ˈstrætədʒi" },
  { word: "consensus", partOfSpeech: "noun", meaning: "General agreement among a group.", simpleExplanation: "When most people agree.", example: "The committee reached a consensus.", synonyms: ["agreement", "accord", "unity"], antonyms: ["disagreement", "conflict"], pronunciation: "kənˈsɛnsəs" },
];
...
function generateLocalVocabFallback(text: string): VocabEntry[] {
  ...
  const words = text
    ...
    .filter((w) => w.length >= 7 && w.length <= 14 && !STOPWORDS.has(w));
