...
import { PageEndAd } from "@/components/ads/EzoicAd";
...
export const Route = createFileRoute("/briefing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Today's most important discoveries, sciences, and stories — curated daily." },
      { property: "og:site_name", content: SITE_NAME },
      { property: "og:title", content: "Daily Earth Briefing — The United Hell" },
      { property: "og:description", content: "Today's most important discoveries, sciences, and stories." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: canonicalUrl("/briefing") },
      { property: "og:image", content: SITE_LOGO },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Daily Earth Briefing — The United Hell" },
      { name: "twitter:description", content: "Today's most important discoveries, sciences, and stories." },
    ],
    links: [
  ...
  return (
    <div className="container-edit py-10 md:py-16">
      <header className="text-center border-b rule pb-10 mb-12">
        ...
        <h1 className="display-1 mt-4">Daily Briefing</h1>
