...
export const CATEGORIES: Category[] = [
  ...
  { slug: "horoscope", label: "Horoscope", description: "", icon: "sparkles" },
  { slug: "palmistry", label: "Palmistry", description: "", icon: "hand" },
  { slug: "numerology", label: "Numerology", description: "", icon: "hash" },
  { slug: "vedic-astrology", label: "Vedic Astrology", description: "", icon: "om" },
  ...
  // 🇳🇴 NORWAY
  { slug: "norway", label: "Norway", description: "", icon: "map-pin" },
  { slug: "norway-news", label: "Norway News", description: "", icon: "newspaper" },
  { slug: "norway-politics", label: "Norway Politics", description: "", icon: "landmark" },
  { slug: "norway-business", label: "Norway Business", description: "", icon: "trending-up" },
  { slug: "norway-culture", label: "Norway Culture", description: "", icon: "palette" },
  { slug: "norway-nature", label: "Norway Nature", description: "", icon: "tree-pine" },
  { slug: "norway-energy", label: "Norway Energy", description: "", icon: "zap" },
  { slug: "norway-technology", label: "Norway Technology", description: "", icon: "cpu" },
  { slug: "norway-society", label: "Norway Society", description: "", icon: "users" },
  { slug: "norway-history", label: "Norway History", description: "", icon: "history" },
...
export const CATEGORY_SECTIONS: CategorySection[] = [
  ...
  categories: CATEGORIES.filter(c => ["philosophy", "ethics", "spirituality", "astrology", "horoscope", "palmistry", "numerology", "vedic-astrology", "wisdom", "meditation", "ancient-traditions"].includes(c.slug)),
  },
  { title: "EDUCATION",
  ...
  { title: "NORWAY",
  categories: CATEGORIES.filter(c => ["norway", "norway-news", "norway-politics", "norway-business", "norway-culture", "norway-nature", "norway-energy", "norway-technology", "norway-society", "norway-history"].includes(c.slug)),
  },
