import { a as getRelatedBooks, i as getBookBySlug, n as BOOKS, t as AUTHOR } from "./editions-data-WnTS0RgW.js";
import { t as Route } from "./editions._slug-D13p6lZ4.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { BookOpen, Bookmark, Calendar, Check, ChevronLeft, ChevronRight, Clock, Eye, FileText, Globe, Heart, Share2, ShoppingBag, User } from "lucide-react";
//#region src/routes/editions.$slug.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-[#090705] via-[#0F0906] to-[#140B07]" }), Array.from({ length: 40 }).map((_, i) => /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "absolute -inset-4 bg-gradient-to-br from-[#F4B860]/15 to-[#C49752]/10 blur-2xl rounded-sm" }),
							/* @__PURE__ */ jsxs("div", {
								...
								}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-sm bg-gradient-to-t from-black/20 via-transparent to-transparent pointer-events-none" })]
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("button", {
										...
										"aria-label": "Wishlist",
										children: /* @__PURE__ */ jsx(Heart, { className: `h-4 w-4 ${isFavorite ? "fill-[#E6C17D] text-[#E6C17D]" : "text-[#E6C17D]"}` })
									}),
									/* @__PURE__ */ jsx("button", {
										onClick: copyLink,
										className: "w-10 h-10 flex items-center justify-center border border-[#E6C17D]/25 rounded-sm hover:bg-[#E6C17D]/10 transition",
										"aria-label": "Share",
										children: copied ? /* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-[#E6C17D]" }) : /* @__PURE__ */ jsx(Share2, { className: "h-4 w-4 text-[#E6C17D]" })
									}),
									/* @__PURE__ */ jsx("button", {
										className: "w-10 h-10 flex items-center justify-center border border-[#E6C17D]/25 rounded-sm hover:bg-[#E6C17D]/10 transition",
										"aria-label": "Bookmark",
										children: /* @__PURE__ */ jsx(Bookmark, { className: "h-4 w-4 text-[#E6C17D]" })
									})
								]
							})
						]
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(BookOpen, { className: "h-3 w-3 text-[#E6C17D]" }), /* @__PURE__ */ jsxs("span", {
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: [
									...
									children: [/* @__PURE__ */ jsx(m.icon, { className: "h-4 w-4 text-[#E6C17D]/60 shrink-0" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("a", {
										...
										children: [/* @__PURE__ */ jsx(ShoppingBag, { className: "h-4 w-4" }), " Buy on Amazon"]
									}),
									/* @__PURE__ */ jsx("a", {
									...
									/* @__PURE__ */ jsxs("button", {
										className: "inline-flex items-center gap-2 px-7 py-3.5 border border-[#E6C17D]/40 text-[#E6C17D] text-xs font-medium uppercase tracking-widest rounded-sm hover:bg-[#E6C17D]/10 transition-all",
										children: [/* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" }), " Read Sample"]
									})
								]
							}),
							/* @__PURE__ */ jsx("div", {
								className: "flex flex-wrap gap-2 pt-2",
								children: book.formats.map((f) => /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "About the Book" }), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-3xl mx-auto",
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "What You'll Learn" }), /* @__PURE__ */ jsx("ul", {
						className: "grid sm:grid-cols-2 gap-3",
						children: book.whatYouWillLearn.map((item, i) => /* @__PURE__ */ jsxs("li", {
							className: "flex items-start gap-3 text-sm text-[#FFF2D8]/70",
							children: [/* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-[#E6C17D] shrink-0 mt-0.5" }), item]
						}, i))
					})]
				})
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-3xl mx-auto",
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "Key Topics" }), /* @__PURE__ */ jsx("div", {
						className: "flex flex-wrap gap-2",
						children: book.keyTopics.map((t) => /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-3xl mx-auto",
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "Who Should Read This" }), /* @__PURE__ */ jsx("ul", {
						className: "space-y-3",
						children: book.targetAudience.map((a, i) => /* @__PURE__ */ jsxs("li", {
							className: "flex items-start gap-3 text-sm text-[#FFF2D8]/70",
							children: [/* @__PURE__ */ jsx(User, { className: "h-4 w-4 text-[#E6C17D]/60 shrink-0 mt-0.5" }), a]
						}, i))
					})]
				})
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-3xl mx-auto",
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "Why Read This Book" }), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-3xl mx-auto",
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "Table of Contents" }), /* @__PURE__ */ jsx("ol", {
						className: "space-y-2",
						children: book.tableOfContents.map((ch, i) => /* @__PURE__ */ jsxs("li", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-3xl mx-auto",
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "Reading Level" }), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "The Powerful Mind Series" }), /* @__PURE__ */ jsxs("div", {
						className: "relative",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute left-0 top-0 bottom-0 w-px bg-gradient-to-b from-[#E6C17D]/40 via-[#E6C17D]/20 to-transparent" }), /* @__PURE__ */ jsx("div", {
							className: "space-y-4",
							children: BOOKS.map((b) => /* @__PURE__ */ jsxs(Link, {
								to: "/editions/$slug",
								params: { slug: b.slug },
								...
								children: [
									/* @__PURE__ */ jsx("div", { className: `absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full ${b.slug === slug ? "bg-[#E6C17D] shadow-[0_0_10px_rgba(230,193,125,0.5)]" : "bg-[#E6C17D]/30"}` }),
									/* @__PURE__ */ jsx("img", {
										src: b.coverImage,
										alt: b.title,
			...
			related.length > 0 && /* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionDivider, { label: "Related Editions" }), /* @__PURE__ */ jsx("div", {
						className: "grid grid-cols-2 md:grid-cols-4 gap-6",
						children: related.map((b, i) => /* @__PURE__ */ jsxs(Link, {
							to: "/editions/$slug",
							params: { slug: b.slug },
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(SectionDivider, { label: "About the Author" }),
						/* @__PURE__ */ jsx("img", {
							src: AUTHOR.logo,
							alt: AUTHOR.name,
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [prevBook ? /* @__PURE__ */ jsxs(Link, {
						to: "/editions/$slug",
						...
						children: [/* @__PURE__ */ jsx(ChevronLeft, { className: "h-5 w-5 text-[#E6C17D]/40 group-hover:text-[#E6C17D] transition" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
					...
					}) : /* @__PURE__ */ jsx("div", { className: "flex-1" }), nextBook ? /* @__PURE__ */ jsxs(Link, {
						to: "/editions/$slug",
						...
						})] }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5 text-[#E6C17D]/40 group-hover:text-[#E6C17D] transition" })]
...
function SectionDivider({ label }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "h-px flex-1 max-w-[60px] bg-gradient-to-r from-transparent to-[#E6C17D]/40" }),
			/* @__PURE__ */ jsx("span", {
				className: "text-[0.7rem] uppercase tracking-[0.3em] text-[#E6C17D]",
				children: label
			}),
			/* @__PURE__ */ jsx("div", { className: "h-px flex-1 max-w-[60px] bg-gradient-to-l from-transparent to-[#E6C17D]/40" })
		]
	});
}
//#endregion
