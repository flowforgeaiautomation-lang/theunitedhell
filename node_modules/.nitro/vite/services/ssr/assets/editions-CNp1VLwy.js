import { n as BOOKS, r as COLLECTIONS, t as AUTHOR } from "./editions-data-WnTS0RgW.js";
import { useEffect, useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowDown, ArrowRight, Eye, Heart, Search, ShoppingBag, Sparkles, Star, X } from "lucide-react";
...
function EditionsPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(EditionsBackground, {}),
			/* @__PURE__ */ jsxs("section", {
				className: "relative min-h-[60vh] flex flex-col items-center justify-center px-4 py-12 z-10",
				children: [/* @__PURE__ */ jsx("div", {
					className: "absolute inset-0 pointer-events-none",
					children: /* @__PURE__ */ jsx("div", { className: "absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-[#F4B860]/5 blur-[120px]" })
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3 text-[#E6C17D]" }), /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["Explore Collection ", /* @__PURE__ */ jsx(ArrowDown, { className: "h-3.5 w-3.5 group-hover:translate-y-0.5 transition-transform" })]
							}), /* @__PURE__ */ jsx(Link, {
								to: "/editions/$slug",
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-2 bg-gradient-to-br from-[#F4B860]/10 to-[#C49752]/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-sm" }), /* @__PURE__ */ jsx("img", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Star, { className: "h-3 w-3 text-[#E6C17D]" }), /* @__PURE__ */ jsx("span", {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs(Link, {
											...
											children: ["Buy ", /* @__PURE__ */ jsx(ShoppingBag, { className: "h-3 w-3" })]
											...
											children: [/* @__PURE__ */ jsx(Eye, { className: "h-3 w-3" }), " Sample"]
										})]
									})
								]
							})]
						}),
						/* @__PURE__ */ jsx("div", { className: "hidden md:block w-px h-40 bg-gradient-to-b from-transparent via-[#E6C17D]/30 to-transparent" }),
						/* @__PURE__ */ jsxs("div", {
							className: "flex gap-4 items-center",
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-[#E6C17D]/40" }),
									/* @__PURE__ */ jsx("input", {
										value: searchTerm,
									...
									searchTerm && /* @__PURE__ */ jsx("button", {
										...
										children: /* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5 text-[#E6C17D]/40 hover:text-[#E6C17D]" })
									})
								]
							}), /* @__PURE__ */ jsxs("div", {
						...
						filteredBooks.length === 0 ? /* @__PURE__ */ jsx("p", {
							...
							children: filteredBooks.map((book, i) => /* @__PURE__ */ jsx(CompactBookCard, {
								book,
								index: i,
							...
							className: "space-y-2",
							children: filteredBooks.map((book, i) => /* @__PURE__ */ jsx(CompactListRow, {
								book,
								index: i,
								isFavorite: favorites.has(book.slug),
								onFavorite: () => toggleFavorite(book.slug),
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "h-px flex-1 max-w-[80px] bg-gradient-to-r from-transparent to-[#E6C17D]/40" }),
							/* @__PURE__ */ jsx("span", {
								className: "text-[0.65rem] uppercase tracking-[0.3em] text-[#E6C17D]",
								children: "The Series"
							}),
							/* @__PURE__ */ jsx("div", { className: "h-px flex-1 max-w-[80px] bg-gradient-to-l from-transparent to-[#E6C17D]/40" })
						]
					}), /* @__PURE__ */ jsx("div", {
						className: "relative overflow-x-auto pb-4",
						children: /* @__PURE__ */ jsxs("div", {
							className: "relative flex items-center gap-2 min-w-max px-4",
							children: [/* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#E6C17D]/30 to-transparent -translate-y-1/2" }), BOOKS.map((book) => /* @__PURE__ */ jsxs(Link, {
								to: "/editions/$slug",
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["Explore Editions ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3.5 w-3.5" })]
							}), /* @__PURE__ */ jsx(Link, {
								to: "/editions/$slug",
								params: { slug: featuredBook.slug },
...
function EditionsBackground() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-[#C49752]/3 blur-[150px]" })
		]
	});
}
			...
			/* @__PURE__ */ jsx(Link, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("img", {
						...
						loading: "lazy"
					}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" })]
				})
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("button", {
					...
					"aria-label": "Favorite",
					children: /* @__PURE__ */ jsx(Heart, { className: `h-3 w-3 ${isFavorite ? "fill-[#E6C17D] text-[#E6C17D]" : "text-[#E6C17D]"}` })
				}), /* @__PURE__ */ jsx("button", {
					onClick: (e) => {
						e.preventDefault();
						onPreview();
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: books.map((book, i) => /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Link, {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute -inset-1 bg-gradient-to-t from-[#F4B860]/10 to-transparent opacity-0 group-hover:opacity-100 blur-lg transition-opacity rounded-sm" }),
					/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx("div", { className: "h-1 bg-gradient-to-r from-[#C49752]/30 via-[#E6C17D]/30 to-[#C49752]/30 rounded-sm" })
				]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: /* @__PURE__ */ jsx(Heart, { className: `h-2.5 w-2.5 ${favorites.has(book.slug) ? "fill-[#E6C17D] text-[#E6C17D]" : "text-[#E6C17D]"}` })
						}), /* @__PURE__ */ jsx("button", {
							onClick: () => onPreview(book),
							className: "w-6 h-6 flex items-center justify-center border border-[#E6C17D]/20 rounded-sm hover:bg-[#E6C17D]/10 transition",
							children: /* @__PURE__ */ jsx(Eye, { className: "h-2.5 w-2.5 text-[#E6C17D]" })
						})]
					})
				]
			})]
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[#090705]/90 backdrop-blur-md" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("button", {
				...
				"aria-label": "Close",
				children: /* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5 text-[#E6C17D]" })
			}), /* @__PURE__ */ jsxs("div", {
