import { t as translateVisibleText } from "./translation.functions-BIvKV3Qa.js";
...
import { n as articleQ, r as useReadingPrefs, t as Route } from "./article._slug-Bz6z8jwn.js";
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-CZZNFFr0.js";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-BPkEK-MY.js";
import { n as fallbackCoverUrl, t as SmartImage } from "./SmartImage-CM57uCFc.js";
...
import { ArrowBigUp, BookOpen, Bookmark, BookmarkCheck, Building2, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Clock, Gauge, Globe, Globe2, Hash, Heart, Info, Lightbulb, Maximize, MessageCircle, Minimize, Pause, Play, RotateCcw, Search, Share2, SkipBack, SkipForward, Sparkles, Square, Trash2, TrendingUp, Trophy, Users, Volume2, VolumeX, X, XCircle } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { children: currentIdx >= 0 ? currentIdx + 1 : 0 }),
								/* @__PURE__ */ jsx("span", { children: "/" }),
								/* @__PURE__ */ jsx("span", { children: sentences.length })
							]
						}),
						/* @__PURE__ */ jsxs("div", {
				...
				isPlaying && currentIdx >= 0 && /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/hooks/use-live-translation.ts
...
function ImageCarousel({ images, alt, priority = false }) {
	...
	return /* @__PURE__ */ jsxs("figure", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			}), canSwipe && /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsx("button", {
					onClick: (e) => {
						e.stopPropagation();
						go(-1);
...
function EnhancedVocabCard({ entry, articleId, index }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			entry.simpleExplanation && /* @__PURE__ */ jsxs("p", {
			...
			entry.contextInArticle && /* @__PURE__ */ jsxs("p", {
			...
			(entry.synonyms?.length || entry.antonyms?.length || entry.wordOrigin) && /* @__PURE__ */ jsxs("div", {
				className: "mt-3 flex flex-wrap gap-x-6 gap-y-2 text-sm",
				children: [
					entry.synonyms?.length ? /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx("span", {
							className: "font-semibold text-foreground/80",
							children: "Synonyms:"
						}),
					...
					entry.antonyms?.length ? /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx("span", {
							className: "font-semibold text-foreground/80",
							children: "Antonyms:"
						}),
					...
					entry.wordOrigin && /* @__PURE__ */ jsxs("div", {
...
function ArticlePage() {
	...
	return /* @__PURE__ */ jsxs("article", { children: [
		...
		/* @__PURE__ */ jsx(motion.div, {
			...
			children: /* @__PURE__ */ jsx(ImageCarousel, {
					...
					children: [
						...
						related.length > 0 && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: related.slice(0, 6).map((a) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", {
									href: `/article/${a.slug}`,
									...
									children: [
										...
										a.read_time_minutes && /* @__PURE__ */ jsxs("span", {
											className: "text-xs text-muted-foreground",
