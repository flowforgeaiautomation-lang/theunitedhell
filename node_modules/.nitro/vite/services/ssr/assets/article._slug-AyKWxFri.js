import { t as translateVisibleText } from "./translation.functions-Cups3_K8.js";
...
import { n as articleQ, r as useReadingPrefs, t as Route } from "./article._slug-DZT3D_Qk.js";
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-C2bzC8ee.js";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-m1y6biQ0.js";
...
import { ArrowBigUp, BookOpen, Bookmark, BookmarkCheck, Building2, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Gauge, Globe, Globe2, Hash, Heart, Info, Lightbulb, Maximize, MessageCircle, Minimize, Pause, Play, RotateCcw, Search, Share2, SkipBack, SkipForward, Sparkles, Square, Trash2, TrendingUp, Trophy, Users, Volume2, VolumeX, X, XCircle } from "lucide-react";
...
//#endregion
//#region src/components/MediaCarousel.tsx
	...
	return /* @__PURE__ */ jsxs("figure", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: media.map((item, i) => /* @__PURE__ */ jsx("div", {
					className: "relative h-full w-full shrink-0",
					children: item.type === "video" ? /* @__PURE__ */ jsx(VideoPlayer, {
						ref: videoRef,
						src: item.src,
						poster: item.poster,
						active: i === index
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: media.map((_, i) => /* @__PURE__ */ jsx("button", {
						onClick: (e) => {
							e.stopPropagation();
							setIndex(i);
						},
...
var VideoPlayer = forwardRef(function VideoPlayer({ src, poster, active }, ref) {
...
function ArticlePage() {
	...
	return /* @__PURE__ */ jsxs("article", { children: [
		...
		/* @__PURE__ */ jsxs(motion.header, {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: addedDate && /* @__PURE__ */ jsx("span", { children: addedDate })
				}),
				/* @__PURE__ */ jsx("div", {
		...
		/* @__PURE__ */ jsx(motion.div, {
			...
			children: /* @__PURE__ */ jsx(MediaCarousel, {
				media: articleMedia,
				alt: article.title,
				priority: true
			})
