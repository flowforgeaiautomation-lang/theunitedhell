...
import { a as categoryLabel, i as HOMEPAGE_CATEGORIES } from "./categories-BEROsZZ5.js";
...
import { n as curateNowPublic, t as curateNow } from "./ai.functions-C7WoeUel.js";
import { t as ArticleCard } from "./article-card-Cy55uR6v.js";
...
//#region src/components/HomepageNav.tsx
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [mainCategories.map((cat) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [Icon && /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4" }), cat.label]
					}, cat.slug);
				}), onExploreAllClick ? /* @__PURE__ */ jsxs("button", {
					...
					children: ["Explore All Fields", /* @__PURE__ */ jsx(Icons.ArrowRight, { className: "h-4 w-4" })]
				}) : /* @__PURE__ */ jsxs(Link, {
					to: "/discover",
...
//#endregion
//#region src/routes/discover.tsx?tsr-split=component
var COUNTRY_LABELS = {
	IN: "India",
	US: "United States",
	GB: "United Kingdom",
...
function DiscoverPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			articles.length === 0 && !articlesQuery.isLoading && !articlesQuery.isError && articlesQuery.isFetched && /* @__PURE__ */ jsxs("div", {
			...
			articlesQuery.isLoading && /* @__PURE__ */ jsx("div", {
				className: "grid gap-12 sm:grid-cols-2 lg:grid-cols-3",
				children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
					className: "animate-pulse",
					children: [
						/* @__PURE__ */ jsx("div", { className: "aspect-[4/3] w-full bg-foreground/10" }),
						/* @__PURE__ */ jsx("div", { className: "mt-4 h-4 w-1/3 bg-foreground/10" }),
						/* @__PURE__ */ jsx("div", { className: "mt-3 h-6 w-full bg-foreground/10" }),
						/* @__PURE__ */ jsx("div", { className: "mt-2 h-4 w-2/3 bg-foreground/10" })
					]
				}, i))
			}),
			/* @__PURE__ */ jsx("div", {
			...
			!hasMore && articles.length > 0 && /* @__PURE__ */ jsx("div", {
