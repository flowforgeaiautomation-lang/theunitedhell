...
import { n as curateNowPublic, t as curateNow } from "./ai.functions-DaRLW-Qr.js";
		...
		children: [
			...
			loading && /* @__PURE__ */ jsx("div", {
				...
				children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "aspect-[4/3] bg-foreground/10 mb-4" }),
						/* @__PURE__ */ jsx("div", { className: "h-3 w-20 bg-foreground/10 mb-3" }),
						/* @__PURE__ */ jsx("div", { className: "h-5 w-full bg-foreground/10 mb-2" }),
						/* @__PURE__ */ jsx("div", { className: "h-5 w-2/3 bg-foreground/10" })
					]
				}, i))
			}),
			!loading && articles.length > 0 && /* @__PURE__ */ jsx("div", {
				className: "grid gap-12 sm:grid-cols-2 lg:grid-cols-3",
				children: articles.map((article, i) => /* @__PURE__ */ jsx("div", {
			...
			!loading && articles.length === 0 && /* @__PURE__ */ jsxs("div", {
			...
			!hasMore && !loading && articles.length > 0 && /* @__PURE__ */ jsx("div", {
