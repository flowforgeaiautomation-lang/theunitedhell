...
import { a as categoryLabel, t as CATEGORIES } from "./categories-CY0cJTXM.js";
import { a as searchEditions } from "./editions-data-CBkYZZRA.js";
import { s as listArticles, u as searchArticles } from "./articles.functions-C8ZG7BU6.js";
import { t as Route } from "./search-3puU64P7.js";
import { t as ArticleCard } from "./article-card-vLHOrR7y.js";
...
function SearchPage() {
	...
	const [country, setCountry] = useState(void 0);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("form", {
				...
				className: "relative",
				children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
					autoFocus: true,
					value: q,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				}), (category || country || sort !== "recent") && /* @__PURE__ */ jsxs("button", {
					onClick: reset,
					className: "inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground transition",
					children: [/* @__PURE__ */ jsx(X, { className: "h-3 w-3" }), " Clear filters"]
				})]
			}),
				...
				children: [
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: "All"
						}), CATEGORIES.filter((c) => c.slug !== "all").map((c) => /* @__PURE__ */ jsx("button", {
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: "All"
						}), Object.entries(COUNTRY_LABELS).map(([code, label]) => /* @__PURE__ */ jsx("button", {
			...
			(submitted || category || country) && /* @__PURE__ */ jsxs("div", {
				className: "mt-10",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "kicker mb-6",
						children: [submitted ? `Results for "${submitted}"` : category ? categoryLabel(category) : "All stories", displayed.length > 0 && /* @__PURE__ */ jsxs("span", {
					...
					query.isLoading && /* @__PURE__ */ jsx(ArticleCardSkeletonGrid, { count: 4 }),
					query.data && displayed.length === 0 && editionResults.length === 0 && /* @__PURE__ */ jsx("p", {
						className: "dek",
						children: "No matches. Try different keywords or filters."
					}),
					editionResults.length > 0 && /* @__PURE__ */ jsxs("div", {
						className: "mb-12",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2 mb-4",
							children: [/* @__PURE__ */ jsx(BookOpen, { className: "h-4 w-4 text-[#E6C17D]" }), /* @__PURE__ */ jsx("span", {
								className: "text-xs uppercase tracking-widest text-muted-foreground",
								children: "Editions"
							})]
						}), /* @__PURE__ */ jsx("div", {
							className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3",
							children: editionResults.map((b) => /* @__PURE__ */ jsxs(Link, {
								to: "/editions/$slug",
								params: { slug: b.slug },
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: displayed.map((a) => /* @__PURE__ */ jsx(ArticleCard, {
							article: a,
							variant: "default"
						}, a.id))
					})
			...
			!submitted && !category && !country && /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						className: "grid gap-10 sm:grid-cols-2",
						children: displayed.slice(0, 6).map((a) => /* @__PURE__ */ jsx(ArticleCard, {
							article: a,
							variant: "default"
						}, a.id))
					})
