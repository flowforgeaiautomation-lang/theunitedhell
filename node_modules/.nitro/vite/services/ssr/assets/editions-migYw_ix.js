						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsx("span", { children: selectedBook.publicationDate.kindle }),
										/* @__PURE__ */ jsx("span", {
										...
										/* @__PURE__ */ jsx("span", { children: selectedBook.readingTime })
									]
								}),
								/* @__PURE__ */ jsxs("a", {
									...
									children: ["Buy on Amazon ", /* @__PURE__ */ jsx(ExternalLink, { className: "h-3 w-3" })]
								})
							]
						}, selectedBook.slug)]
					})
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							searchTerm && /* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4 text-white/30 hover:text-white" })
							})
						]
					})
				})
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						className: "space-y-1",
						children: filteredBooks.map((book, i) => /* @__PURE__ */ jsx(BookRow, {
							book,
							index: i,
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
							...
							children: ["View Author ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
						})
					]
				})
			})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("a", {
				...
				children: [/* @__PURE__ */ jsx(ExternalLink, { className: "h-3 w-3" }), " Buy"]
			})
		]
	});
}
