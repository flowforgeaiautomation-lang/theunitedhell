import { n as BOOKS, t as AUTHOR } from "./editions-data-CBkYZZRA.js";
import { t as Route } from "./editions-BfurqzyD.js";
...
function EditionsPage() {
	...
	const selectedBook = useMemo(() => BOOKS.find((b) => b.slug === selectedSlug) ?? BOOKS[0], [selectedSlug]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("span", { children: ["Published ", selectedBook.publicationDate.kindle] }),
										/* @__PURE__ */ jsx("span", { children: "·" }),
										/* @__PURE__ */ jsx("span", { children: selectedBook.language })
									]
								}),
								/* @__PURE__ */ jsxs("a", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsx("div", {
					className: "max-w-5xl mx-auto",
					children: filteredBooks.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("a", {
							...
							children: ["View Author ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3.5 w-3.5" })]
						})
					]
				})
			})
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("span", { children: book.publicationDate.kindle }),
							/* @__PURE__ */ jsx("span", { children: "·" }),
							/* @__PURE__ */ jsx("span", { children: book.language })
						]
					})
				]
			}),
