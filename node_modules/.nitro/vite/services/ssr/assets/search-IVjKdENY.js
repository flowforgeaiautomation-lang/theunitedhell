...
import { f as searchArticles, l as listArticles } from "./articles.functions-C7SBoTOX.js";
import { t as Route } from "./search-C_alrPa2.js";
		...
		children: [
			...
			(submitted || category || country) && /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					query.data && displayed.length === 0 && /* @__PURE__ */ jsx("p", {
						className: "dek",
