...
import { n as articleQ, r as useReadingPrefs, t as Route } from "./article._slug-DmQhu4jP.js";
...
import { n as fallbackCoverUrl, t as SmartImage } from "./SmartImage-CSltlVaf.js";
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							story.vocabulary && story.vocabulary.length > 0 ? /* @__PURE__ */ jsx("div", {
								...
								children: enhanceVocabEntries(story.vocabulary).map((v, i) => /* @__PURE__ */ jsx(EnhancedVocabCard, {
									entry: v,
									articleId: article.id,
									index: i
								}, `${v.word}-${i}`))
