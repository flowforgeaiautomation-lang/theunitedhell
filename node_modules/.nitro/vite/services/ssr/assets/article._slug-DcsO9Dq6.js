...
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-DpGGDsg6.js";
import { n as articleQ, t as Route } from "./article._slug-CEyK3fxi.js";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-De3pSaMS.js";
import { n as fallbackCoverUrl, t as ArticleCard } from "./article-card-Cy55uR6v.js";
...
function EnhancedVocabCard({ entry, articleId, index }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			entry.simpleExplanation && entry.simpleExplanation !== entry.meaning && /* @__PURE__ */ jsxs("p", {
			...
			entry.contextMeaning && /* @__PURE__ */ jsxs("p", {
...
function ArticlePage() {
	...
	return /* @__PURE__ */ jsxs("article", { children: [
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						story.reader_takeaways && story.reader_takeaways.length > 0 && /* @__PURE__ */ jsx(ListBlock, {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					}), /* @__PURE__ */ jsx(KnowledgeCheckReflection, {
						articleId: article.id,
						story,
						title: article.title
					})]
		...
		related.length > 0 && /* @__PURE__ */ jsxs(motion.section, {
			initial: { opacity: 0 },
