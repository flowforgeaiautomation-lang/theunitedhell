...
//#region src/lib/translation.functions.ts?tss-serverfn-split
...
async function aiTranslate(texts, target) {
	const { orChat } = await import("./openrouter.server-qFv0nSp-.js");
...
var translateVisibleText = createServerFn({ method: "POST" }).inputValidator((d) => z.object({
...
var translateArticle = createServerFn({ method: "POST" }).inputValidator((d) => z.object({
	slug: z.string().min(1),
