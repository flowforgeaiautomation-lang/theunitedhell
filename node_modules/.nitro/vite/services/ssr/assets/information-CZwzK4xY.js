...
//#region src/routes/information.tsx?tsr-split=component
var sections = [
	{
		id: "about",
			...
			children: [/* @__PURE__ */ jsx("aside", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("nav", {
						className: "space-y-2",
						children: sections.map((section) => /* @__PURE__ */ jsx("button", {
				...
				children: [
							...
							/* @__PURE__ */ jsxs("ul", {
								...
								children: [
									/* @__PURE__ */ jsxs("li", { children: [
										...
										/* @__PURE__ */ jsx("strong", { children: "aA" }),
										" icon in the address bar)."
									] }),
									/* @__PURE__ */ jsxs("li", { children: [
										"Tap ",
										/* @__PURE__ */ jsx("strong", { children: "\"Translate\"" }),
										" or ",
										/* @__PURE__ */ jsx("strong", { children: "\"Translate page…\"" }),
										"."
									] }),
									/* @__PURE__ */ jsx("li", { children: "Choose the language you want — Hindi, Spanish, Arabic, Chinese, French, German, Japanese, Portuguese, Russian, or any other supported language." }),
									/* @__PURE__ */ jsx("li", { children: "The entire page, including every article, will be translated instantly. Your choice is remembered for future visits." })
								]
							}),
							/* @__PURE__ */ jsx("p", {
								className: "font-serif text-lg leading-relaxed",
					...
					/* @__PURE__ */ jsxs(Section, {
						...
						children: [/* @__PURE__ */ jsxs("ul", {
							...
							children: [
								/* @__PURE__ */ jsx("li", { children: "Accuracy before speed." }),
								/* @__PURE__ */ jsx("li", { children: "Knowledge before noise." }),
								/* @__PURE__ */ jsx("li", { children: "Context before opinion." }),
								/* @__PURE__ */ jsx("li", { children: "Curiosity before assumptions." }),
								/* @__PURE__ */ jsx("li", { children: "Quality before quantity." })
							]
						}), /* @__PURE__ */ jsx("p", {
					...
					/* @__PURE__ */ jsxs(Section, {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("ul", {
								...
								children: [
									/* @__PURE__ */ jsx("li", { children: "News organizations" }),
									/* @__PURE__ */ jsx("li", { children: "Government agencies" }),
									/* @__PURE__ */ jsx("li", { children: "Research institutions" }),
									/* @__PURE__ */ jsx("li", { children: "Scientific publications" }),
									/* @__PURE__ */ jsx("li", { children: "Educational sources" }),
									/* @__PURE__ */ jsx("li", { children: "Public databases" }),
									/* @__PURE__ */ jsx("li", { children: "Space agencies" }),
									/* @__PURE__ */ jsx("li", { children: "Historical archives" }),
									/* @__PURE__ */ jsx("li", { children: "Verified public sources" })
								]
							}),
							/* @__PURE__ */ jsx("p", {
								className: "font-serif text-lg leading-relaxed",
					...
					/* @__PURE__ */ jsxs(Section, {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("ul", {
								className: "font-serif text-lg leading-relaxed space-y-2 mb-6",
								children: [
									/* @__PURE__ */ jsx("li", { children: "Content discovery" }),
									/* @__PURE__ */ jsx("li", { children: "Summarization" }),
									/* @__PURE__ */ jsx("li", { children: "Classification" }),
									/* @__PURE__ */ jsx("li", { children: "Tagging" }),
									/* @__PURE__ */ jsx("li", { children: "Recommendations" }),
									/* @__PURE__ */ jsx("li", { children: "Personalization" }),
									/* @__PURE__ */ jsx("li", { children: "Content organization" })
								]
							}),
							/* @__PURE__ */ jsx("p", {
								className: "font-serif text-lg leading-relaxed",
					...
					/* @__PURE__ */ jsxs(Section, {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ jsx("strong", { children: "Data Collection:" }), " We may collect anonymous usage data such as pages visited, time spent, browser type, and device information. If you create an account, we store your email address and reading preferences."]
							}),
							/* @__PURE__ */ jsxs("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ jsx("strong", { children: "Google AdSense & Cookies:" }), " Third-party vendors, including Google, use cookies to serve ads based on a user's prior visits to this and other websites. Google's use of advertising cookies enables it and its partners to serve ads to you based on your visit to this site and/or other sites on the internet."]
							}),
							/* @__PURE__ */ jsxs("ul", {
								className: "font-serif text-lg leading-relaxed space-y-2 mb-4 pl-6 list-disc",
								children: [
									/* @__PURE__ */ jsx("li", { children: "Google may use the DoubleClick DART cookie to serve ads based on prior visits." }),
									/* @__PURE__ */ jsxs("li", { children: [
							...
							/* @__PURE__ */ jsxs("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ jsx("strong", { children: "Analytics:" }), " We use Google Analytics and Microsoft Clarity to understand site usage. These tools collect anonymous, aggregated data."]
							}),
							/* @__PURE__ */ jsxs("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ jsx("strong", { children: "Data Retention:" }), " Anonymous usage data is retained for up to 14 months. Account data is retained until account deletion is requested."]
							}),
							/* @__PURE__ */ jsxs("p", {
								className: "font-serif text-lg leading-relaxed mb-4",
								children: [/* @__PURE__ */ jsx("strong", { children: "Your Rights:" }), " You may request access to, correction of, or deletion of your personal data by contacting us at theunitedhell@gmail.com."]
							}),
							/* @__PURE__ */ jsx("p", {
								className: "font-serif text-lg leading-relaxed",
					...
					/* @__PURE__ */ jsxs(Section, {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("ul", {
								className: "font-serif text-lg leading-relaxed space-y-2 mb-6",
								children: [
									/* @__PURE__ */ jsx("li", { children: "Be respectful." }),
									/* @__PURE__ */ jsx("li", { children: "Avoid harassment." }),
									/* @__PURE__ */ jsx("li", { children: "Avoid hate speech." }),
									/* @__PURE__ */ jsx("li", { children: "Avoid misinformation." }),
									/* @__PURE__ */ jsx("li", { children: "Avoid spam." }),
									/* @__PURE__ */ jsx("li", { children: "Avoid illegal activity." })
								]
							}),
							/* @__PURE__ */ jsx("p", {
								className: "font-serif text-lg leading-relaxed",
