...
import { c as getRelated, d as postReflection, n as deleteCommentAnon, r as editComment, s as getLikedComments, t as bumpLike, u as listComments } from "./articles.functions-DjcJbloA.js";
import { n as articleQ, t as Route } from "./article._slug-DLsxnAGT.js";
import { a as toggleBookmark, o as toggleLike, t as getMyInteractions } from "./interactions.functions-guDCACNc.js";
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							story.vocabulary && story.vocabulary.filter((v) => v.meaning).length > 0 ? /* @__PURE__ */ jsx("div", {
								className: "grid gap-6",
								children: story.vocabulary.filter((v) => v.meaning).map((v, i) => /* @__PURE__ */ jsx(EnhancedVocabCard, {
									entry: v,
									articleId: article.id,
									index: i
								}, `${v.word}-${i}`))
								...
								className: "grid gap-6",
								children: generateLocalVocabFallback(story.summary || story.main_story || article.dek || article.title || "").filter((v) => v.meaning).map((v, i) => /* @__PURE__ */ jsx(EnhancedVocabCard, {
									entry: v,
									articleId: article.id,
									index: i
								}, `${v.word}-${i}`))
