...
import { i as getRelated, o as listComments } from "./articles.functions-D2OsHuPk.js";
import { n as articleQ, t as Route } from "./article._slug-B9sHjbpD.js";
import { a as postComment, c as toggleLike, n as getMyInteractions, s as toggleBookmark, t as deleteComment } from "./interactions.functions-B44uS37Y.js";
...
var toggleCommentLike = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({ commentId: z.string().uuid() }).parse(d)).handler(createSsrRpc("3818bce773c3be4ba554055b02c3855cb1a43083d49b2ccec573ca368210b885"));
//#endregion
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			!submitted && /* @__PURE__ */ jsxs("div", {
				...
				}), reflectionQuestion && answers[reflectionQuestion.id]?.trim() && /* @__PURE__ */ jsx("button", {
					onClick: () => {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						signedIn && !isReply && /* @__PURE__ */ jsxs("button", {
							onClick: () => {
								setReplyingTo(replyingTo === c.id ? null : c.id);
								setReplyBody("");
							},
							className: "flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground transition",
							children: [/* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Reply" })]
						}),
				...
				replyingTo === c.id && signedIn && /* @__PURE__ */ jsxs("div", {
					className: "mt-4 ml-2",
