...
import { z } from "zod";
//#region src/lib/panchang-functions.ts?tss-serverfn-split
...
var getCurrentPanchang = createServerFn({ method: "GET" }).inputValidator((d) => z.object({}).parse(d ?? {})).handler(getCurrentPanchang_createServerFn_handler, async () => {
	const now = nowInIndia();
