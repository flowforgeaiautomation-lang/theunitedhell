...
var listComments = createServerFn({ method: "GET" }).inputValidator((d) => z.object({ articleId: z.string().uuid() }).parse(d)).handler(listComments_createServerFn_handler, async ({ data }) => {
	const supabase = publicClient();
