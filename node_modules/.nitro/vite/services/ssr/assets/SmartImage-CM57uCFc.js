...
//#region src/lib/article-images.ts
...
//#endregion
//#region src/components/SmartImage.tsx
/**
...
function SmartImage({ src, alt, width, height, loading = "lazy", className = "", placeholder, aspectClass = "" }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			!loaded && !error && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 animate-pulse bg-gradient-to-br from-foreground/[0.04] via-foreground/[0.08] to-foreground/[0.04]" }),
			placeholder && !loaded && /* @__PURE__ */ jsx("img", {
				src: placeholder,
				alt: "",
				"aria-hidden": true,
