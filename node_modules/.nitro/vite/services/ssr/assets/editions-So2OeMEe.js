import { n as BOOKS, r as COLLECTIONS, t as AUTHOR } from "./editions-data-Y6lVczm9.js";
import { useEffect, useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowDown, ArrowRight, ChevronRight, Eye, Heart, Search, ShoppingBag, Sparkles, Star, X } from "lucide-react";
//#region src/routes/editions.tsx?tsr-split=component
function EditionsPage() {
	const [viewMode, setViewMode] = useState("grid");
	const [sortBy, setSortBy] = useState("latest");
	const [activeCollection, setActiveCollection] = useState(void 0);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(EditionsBackground, { scrollY }),
			/* @__PURE__ */ jsxs("section", {
				className: "relative min-h-[92vh] flex flex-col items-center justify-center px-4 py-20 z-10",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "absolute inset-0 pointer-events-none",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-[#F4B860]/5 blur-[120px]" }), /* @__PURE__ */ jsx("div", { className: "absolute bottom-1/4 left-1/3 w-[400px] h-[400px] rounded-full bg-[#C49752]/5 blur-[100px]" })]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-[#E6C17D]" }), /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("a", {
									...
									children: ["Explore Collection", /* @__PURE__ */ jsx(ArrowDown, { className: "h-4 w-4 group-hover:translate-y-0.5 transition-transform" })]
								}), /* @__PURE__ */ jsx(Link, {
									to: "/editions/$slug",
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(ArrowDown, { className: "h-5 w-5 text-[#E6C17D]/50" })
					})
				]
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "h-px flex-1 bg-gradient-to-r from-transparent via-[#E6C17D]/40 to-transparent" }),
							/* @__PURE__ */ jsx("span", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-4 bg-gradient-to-br from-[#F4B860]/10 to-[#C49752]/10 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" }), /* @__PURE__ */ jsxs("div", {
								className: "relative aspect-[2/3] max-w-sm mx-auto",
								children: [
									/* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-sm shadow-2xl shadow-[#F4B860]/10 group-hover:shadow-[#F4B860]/30 transition-shadow duration-700" }),
									/* @__PURE__ */ jsx("img", {
									...
									/* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-sm bg-gradient-to-t from-black/30 via-transparent to-transparent pointer-events-none" })
								]
							})]
						}), /* @__PURE__ */ jsxs("div", {
							className: "space-y-6",
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Star, { className: "h-3 w-3 text-[#E6C17D]" }), /* @__PURE__ */ jsxs("span", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs(Link, {
											...
											children: ["Buy Now ", /* @__PURE__ */ jsx(ShoppingBag, { className: "h-3.5 w-3.5" })]
										}),
										/* @__PURE__ */ jsxs(Link, {
											to: "/editions/$slug",
											params: { slug: featuredBook.slug },
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsx("div", { className: "h-px flex-1 max-w-[100px] bg-gradient-to-r from-transparent to-[#E6C17D]/40" }),
										/* @__PURE__ */ jsx("span", {
											className: "text-[0.7rem] uppercase tracking-[0.3em] text-[#E6C17D]",
											children: "The Collection"
										}),
										/* @__PURE__ */ jsx("div", { className: "h-px flex-1 max-w-[100px] bg-gradient-to-l from-transparent to-[#E6C17D]/40" })
									]
								}),
								/* @__PURE__ */ jsx("h2", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#E6C17D]/40" }),
									/* @__PURE__ */ jsx("input", {
										value: searchTerm,
									...
									searchTerm && /* @__PURE__ */ jsx("button", {
										...
										children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4 text-[#E6C17D]/40 hover:text-[#E6C17D]" })
									})
								]
							}), /* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("button", {
								...
								children: "All"
							}), COLLECTIONS.map((c) => /* @__PURE__ */ jsx("button", {
						...
						filteredBooks.length === 0 ? /* @__PURE__ */ jsx("p", {
							...
							children: filteredBooks.map((book, i) => /* @__PURE__ */ jsx(BookCard, {
								book,
								index: i,
						...
						}) : viewMode === "shelf" ? /* @__PURE__ */ jsx(ShelfView, {
							books: filteredBooks,
							favorites,
							...
							className: "space-y-4",
							children: filteredBooks.map((book, i) => /* @__PURE__ */ jsx(BookListRow, {
								book,
								index: i,
								isFavorite: favorites.has(book.slug),
								onFavorite: () => toggleFavorite(book.slug),
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						className: "relative",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#E6C17D]/40 to-transparent -translate-x-1/2 hidden md:block" }), /* @__PURE__ */ jsx("div", {
							className: "space-y-12",
							children: BOOKS.map((book, i) => /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "absolute left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[#E6C17D] shadow-[0_0_15px_rgba(230,193,125,0.5)] hidden md:block z-10" }),
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsx(Link, {
											...
											children: /* @__PURE__ */ jsxs("div", {
												...
												children: [
													...
													/* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-[#E6C17D]/40 group-hover:text-[#E6C17D] group-hover:translate-x-1 transition-all shrink-0 mt-1" })
												]
											})
										})
									})
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-6 bg-gradient-to-br from-[#F4B860]/10 to-[#C49752]/10 blur-2xl rounded-full" }), /* @__PURE__ */ jsx("img", {
								src: AUTHOR.logo,
								alt: AUTHOR.name,
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(Sparkles, { className: "h-5 w-5 text-[#E6C17D]" })
							}), /* @__PURE__ */ jsxs("p", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: AUTHOR.topics.map((t) => /* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", { className: "w-[500px] h-[500px] rounded-full bg-[#F4B860]/5 blur-[120px]" })
						}),
						/* @__PURE__ */ jsxs("h2", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["Explore Editions ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsx(Link, {
								to: "/editions/$slug",
								params: { slug: featuredBook.slug },
			...
			previewBook && /* @__PURE__ */ jsx(PreviewModal, {
				book: previewBook,
...
function EditionsBackground({ scrollY }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-[#090705] via-[#0F0906] to-[#140B07]" }),
			stars.map((s, i) => /* @__PURE__ */ jsx("div", {
...
function BookCard({ book, index, isFavorite, onFavorite, onPreview }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "absolute -inset-2 bg-gradient-to-br from-[#F4B860]/10 to-transparent opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-700 rounded-sm" }),
			/* @__PURE__ */ jsx(Link, {
				to: "/editions/$slug",
				params: { slug: book.slug },
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" }),
						/* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-[#E6C17D]/5 to-transparent pointer-events-none" })
					]
				})
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("button", {
					...
					children: /* @__PURE__ */ jsx(Heart, { className: `h-3.5 w-3.5 ${isFavorite ? "fill-[#E6C17D] text-[#E6C17D]" : "text-[#E6C17D]"}` })
				}), /* @__PURE__ */ jsx("button", {
					onClick: (e) => {
						e.preventDefault();
						onPreview();
					...
					children: /* @__PURE__ */ jsx(Eye, { className: "h-3.5 w-3.5 text-[#E6C17D]" })
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: books.map((book, i) => /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Link, {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute -inset-2 bg-gradient-to-t from-[#F4B860]/10 to-transparent opacity-0 group-hover:opacity-100 blur-lg transition-opacity rounded-sm" }),
					/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx("div", { className: "h-1.5 bg-gradient-to-r from-[#C49752]/30 via-[#E6C17D]/30 to-[#C49752]/30 rounded-sm" })
				]
			}), /* @__PURE__ */ jsxs("div", {
				className: "max-w-xs",
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: /* @__PURE__ */ jsx(Heart, { className: `h-3 w-3 ${favorites.has(book.slug) ? "fill-[#E6C17D] text-[#E6C17D]" : "text-[#E6C17D]"}` })
						}), /* @__PURE__ */ jsx("button", {
							onClick: () => onPreview(book),
							className: "w-7 h-7 flex items-center justify-center border border-[#E6C17D]/20 rounded-sm hover:bg-[#E6C17D]/10 transition",
							children: /* @__PURE__ */ jsx(Eye, { className: "h-3 w-3 text-[#E6C17D]" })
						})]
					})
				]
			})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: book.genre.slice(0, 3).map((g) => /* @__PURE__ */ jsx("span", {
...
function PreviewModal({ book, onClose }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		onClick: onClose,
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[#090705]/90 backdrop-blur-md" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("button", {
				...
				"aria-label": "Close",
				children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4 text-[#E6C17D]" })
			}), /* @__PURE__ */ jsxs("div", {
