...
createServerFn({ method: "POST" }).inputValidator((d) => z.object({ commentId: z.string().uuid() }).parse(d)).handler(createSsrRpc("2e086ce7af653a07e731d4c87fcbedb957daba8b4363dceb296dc7528f30266b"));
createServerFn({ method: "GET" }).inputValidator((d) => z.object({
	slug: z.string().min(1),
	title: z.string(),
	category: z.string()
