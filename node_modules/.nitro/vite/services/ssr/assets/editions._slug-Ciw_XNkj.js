import { i as getRelatedBooks, n as BOOKS, r as getBookBySlug, t as AUTHOR } from "./editions-data-DJWBoHm5.js";
import { t as Route } from "./editions._slug-uMUaNnnE.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { BookOpen, Calendar, Check, ChevronLeft, ChevronRight, Clock, ExternalLink, FileText, Globe, User } from "lucide-react";
		...
		children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsxs("a", {
							...
							children: ["Buy on Amazon ", /* @__PURE__ */ jsx(ExternalLink, { className: "h-3.5 w-3.5" })]
						}),
						/* @__PURE__ */ jsx("div", {
							className: "flex flex-wrap gap-1.5 mt-4",
							children: book.formats.filter((f) => f.available).map((f) => /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Divider, { label: "About the Book" }), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "What You'll Learn" }), /* @__PURE__ */ jsx("ul", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "Key Topics" }), /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "Who Should Read This" }), /* @__PURE__ */ jsx("ul", {
						className: "space-y-2",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "Why Read This Book" }), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "Table of Contents" }), /* @__PURE__ */ jsx("ol", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "Reading Level" }), /* @__PURE__ */ jsx("p", {
						className: "text-sm text-white/60 leading-relaxed",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "max-w-2xl mx-auto",
					children: [/* @__PURE__ */ jsx(Divider, { label: "The Powerful Mind Series" }), /* @__PURE__ */ jsx("div", {
						className: "space-y-1",
			...
			related.length > 0 && /* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Divider, { label: "Related Editions" }), /* @__PURE__ */ jsx("div", {
						className: "grid grid-cols-2 md:grid-cols-4 gap-4",
						children: related.map((b) => /* @__PURE__ */ jsxs(Link, {
							to: "/editions/$slug",
							params: { slug: b.slug },
							className: "group",
							children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
							...
							children: ["View Author ", /* @__PURE__ */ jsx(ChevronRight, { className: "h-3 w-3" })]
						})
					]
				})
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [prevBook ? /* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4 text-white/40 group-hover:text-white transition" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						...
						})] }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-white/40 group-hover:text-white transition" })]
